...
;
(declare-const retMain_110_SYMOBJECT (MyList Int))
(assert (= retMain_110_SYMOBJECT List@378_107_SYMOBJECT))
;(define-fun List@378_67_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147477052))
;                   (seq.++ (seq.unit (- 2147477050))
;                           (seq.++ (seq.unit (- 2147477050))
;                                   (seq.unit (- 2147477052)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147477052))
;                   (seq.++ (seq.unit (- 2147477050))
;                           (seq.++ (seq.unit (- 2147477052)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477052))
;                   (seq.++ (seq.unit (- 2147477053))
;                           (seq.++ (seq.unit (- 2147477052)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477053))
;                           (seq.++ (seq.unit (- 2147477052)) a!3)))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477050))
;                                   (seq.unit (- 2147477052)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477050))
;                           (seq.++ (seq.unit (- 2147477052)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477050))
;                           (seq.++ (seq.unit (- 2147477052)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147477053))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147477053))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052)) a!5)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477053))
;                  (= x!1 (- 2147477050))
;                  (= x!1 (- 2147477052))))
;            (seq.++ (seq.unit (- 2147477050)) a!6)))))))))
...
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477053))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477053))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052)) a!3)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477053))
...
;(let ((a!2 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477050)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477050)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477052))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477050)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147477052))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477050)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147477052))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477053)) a!5)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 11))
;                  (= x!1 322)
;                  (= x!1 8)
...
;                   (seq.++ (seq.unit (- 2147477053))
;                           (seq.++ (seq.unit (- 2147477052)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477053))
;                           (seq.++ (seq.unit (- 2147477052)) a!4)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477053))
...
;                   (seq.++ (seq.unit (- 2147477053))
;                           (seq.++ (seq.unit (- 2147477052)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147477050))
;                   (seq.++ (seq.unit (- 2147477053))
;                           (seq.++ (seq.unit (- 2147477052)) a!5)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477053))
...
;                           (seq.++ (seq.unit (- 2147477052))
;                                   (seq.unit (- 2147477050)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147477053))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477053))
;                   (seq.++ (seq.unit (- 2147477052))
...
;(let ((a!2 (seq.++ (seq.unit (- 2147477052))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477053)) a!1)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477053))
;                  (= x!1 (- 2147477050))
;                  (= x!1 (- 2147477052))))
;            (seq.++ (seq.unit (- 2147477050))
;                    (seq.++ (seq.unit (- 2147477053)) a!2))))))
...
;                (= x!1 (- 2147477052))))
;          (seq.++ (seq.unit (- 2147477050))
;                  (seq.++ (seq.unit (- 2147477053)) (seq.unit (- 2147477052))))))
;(define-fun ret_33_SYMINT () Int
;  1)
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147477053)) (= x!1 (- 2147477050))))
;          (seq.++ (seq.unit (- 2147477050)) (seq.unit (- 2147477053)))))
;(define-fun List@378_7_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147477050))) (seq.unit (- 2147477050))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147477053))
;                   (seq.++ (seq.unit (- 2147477052))
;                           (seq.++ (seq.unit (- 2147477052))
;                                   (seq.unit (- 2147477053)))))))
;  (List_Int (lambda ((x!1 Int))
