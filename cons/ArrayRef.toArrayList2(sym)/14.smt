...
;
(declare-const retMain_70_SYMOBJECT (MyList Int))
(assert (= retMain_70_SYMOBJECT List@378_67_SYMOBJECT))
;(define-fun List@378_67_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 8))
;                   (seq.++ (seq.unit 7) (seq.++ (seq.unit 1053) (seq.unit 888))))))
;(let ((a!2 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit 3004) (seq.++ (seq.unit (- 12)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit (- 13)) (seq.++ (seq.unit 3004) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 8))
;                   (seq.++ (seq.unit (- 8)) (seq.++ (seq.unit (- 13)) a!3)))))
...
;  (let ((a!1 (seq.++ (seq.unit 3004)
;                   (seq.++ (seq.unit (- 12))
;                           (seq.++ (seq.unit (- 8)) (seq.unit 7))))))
;(let ((a!2 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit 3004) (seq.++ (seq.unit (- 13)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 8))
;                   (seq.++ (seq.unit (- 13)) (seq.++ (seq.unit (- 13)) a!2)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 7)
;                  (= x!1 (- 13))
;                  (= x!1 (- 8))
...
;  (let ((a!1 (seq.++ (seq.unit (- 8))
;                   (seq.++ (seq.unit (- 8))
;                           (seq.++ (seq.unit (- 13)) (seq.unit (- 13)))))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 (- 13)) (= x!1 (- 8)))) a!1)))
;(define-fun ret_11_SYMINT () Int
;  (- 8))
;(define-fun List@378_47_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit 3004)
;                   (seq.++ (seq.unit (- 13))
;                           (seq.++ (seq.unit 3004) (seq.unit (- 12)))))))
;(let ((a!2 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit (- 13)) (seq.++ (seq.unit (- 13)) a!1)))))
;  (List_Int (_ as-array k!207)
;            (seq.++ (seq.unit (- 8)) (seq.++ (seq.unit (- 8)) a!2))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit (- 13))
;                           (seq.++ (seq.unit 3004) (seq.unit (- 13)))))))
;(let ((a!2 (seq.++ (seq.unit (- 8))
;                   (seq.++ (seq.unit (- 8)) (seq.++ (seq.unit (- 13)) a!1)))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 (- 13)) (= x!1 (- 8)) (= x!1 3004)))
;            a!2))))
;(define-fun ret_66_SYMINT () Int
;  888)
;(define-fun List@378_62_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 12))
;                   (seq.++ (seq.unit (- 8))
;                           (seq.++ (seq.unit 7) (seq.unit 1053))))))
;(let ((a!2 (seq.++ (seq.unit 3004)
;                   (seq.++ (seq.unit (- 13)) (seq.++ (seq.unit 3004) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit (- 13)) (seq.++ (seq.unit (- 13)) a!2)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 7)
...
;                  (= x!1 (- 12))
;                  (= x!1 3004)))
;            (seq.++ (seq.unit (- 8)) (seq.++ (seq.unit (- 8)) a!3)))))))
;(define-fun List@378_52_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit 3004)
;                           (seq.++ (seq.unit (- 12)) (seq.unit (- 8)))))))
;(let ((a!2 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit (- 13)) (seq.++ (seq.unit 3004) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 8))
;                   (seq.++ (seq.unit (- 8)) (seq.++ (seq.unit (- 13)) a!2)))))
;  (List_Int (_ as-array k!207) a!3)))))
;(define-fun ret_53_SYMINT () Int
;  1)
;(define-fun ret_43_SYMINT () Int
;  1)
;(define-fun List@378_17_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 (- 13)) (= x!1 (- 8))))
;          (seq.++ (seq.unit (- 8)) (seq.++ (seq.unit (- 8)) (seq.unit (- 13))))))
;(define-fun ret_33_SYMINT () Int
;  1)
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 8)))
;          (seq.++ (seq.unit (- 8)) (seq.unit (- 8)))))
;(define-fun List@378_7_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 8))) (seq.unit (- 8))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 13))
;                   (seq.++ (seq.unit (- 13))
;                           (seq.++ (seq.unit (- 13)) (seq.unit 3004))))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 (- 13)) (= x!1 (- 8)) (= x!1 3004)))
;            (seq.++ (seq.unit (- 8)) (seq.++ (seq.unit (- 8)) a!1)))))
...
;  1)
;(define-fun k!207 ((x!0 Int)) Bool
;  (or (= x!0 (- 13)) (= x!0 (- 8)) (= x!0 (- 12)) (= x!0 3004)))