...
;
(declare-const retMain_25_SYMOBJECT (MyList Int))
(assert (= retMain_25_SYMOBJECT List@378_22_SYMOBJECT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147476584))
;                   (seq.++ (seq.unit (- 2147474245))
;                           (seq.++ (seq.unit (- 2147476583))
;                                   (seq.unit (- 2147474244)))))))
...
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147474245)) (= x!1 (- 2147476584))))
;          (seq.++ (seq.unit (- 2147476584)) (seq.unit (- 2147474245)))))
...
;                (= x!1 (- 2147476584))
;                (= x!1 (- 2147476583))))
;          (seq.++ (seq.unit (- 2147476584))
;                  (seq.++ (seq.unit (- 2147474245)) (seq.unit (- 2147476583))))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147476584))) (seq.unit (- 2147476584))))
