...
;
(declare-const retMain_95_SYMOBJECT (MyList Int))
(assert (= retMain_95_SYMOBJECT List@378_92_SYMOBJECT))
;(define-fun List@378_67_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147477195))
;                   (seq.++ (seq.unit (- 2147477195))
;                           (seq.++ (seq.unit (- 2147477195))
;                                   (seq.unit (- 2147477195)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147477199))
;                   (seq.++ (seq.unit (- 2147477195))
;                           (seq.++ (seq.unit (- 2147477199)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477195))
;                   (seq.++ (seq.unit (- 2147477199))
;                           (seq.++ (seq.unit (- 2147477195)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477199))
;                   (seq.++ (seq.unit (- 2147477195))
;                           (seq.++ (seq.unit (- 2147477199)) a!3)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477195)) (= x!1 (- 2147477199))))
;            a!4))))))
...
;                           (seq.++ (seq.unit (- 2147477195))
;                                   (seq.unit (- 2147477195)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147477195))
;                   (seq.++ (seq.unit (- 2147477199))
;                           (seq.++ (seq.unit (- 2147477195)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477199))
;                   (seq.++ (seq.unit (- 2147477195))
;                           (seq.++ (seq.unit (- 2147477199)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477195))
;                   (seq.++ (seq.unit (- 2147477199))
;                           (seq.++ (seq.unit (- 2147477195)) a!3)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477195)) (= x!1 (- 2147477199))))
;            (seq.++ (seq.unit (- 2147477199)) a!4)))))))
...
;                   (seq.++ (seq.unit (- 2147477199))
;                           (seq.++ (seq.unit (- 2147477195)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147477199))
;                   (seq.++ (seq.unit (- 2147477195))
;                           (seq.++ (seq.unit (- 2147477199)) a!4)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 252)
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147477199))
;                   (seq.++ (seq.unit (- 2147477195))
;                           (seq.++ (seq.unit (- 2147477199))
;                                   (seq.unit (- 2147477195)))))))
;  (List_Int (lambda ((x!1 Int))
...
;                   (seq.++ (seq.unit (- 2147477195))
;                           (seq.++ (seq.unit (- 2147477199)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147477195))
;                   (seq.++ (seq.unit (- 2147477199))
;                           (seq.++ (seq.unit (- 2147477195)) a!4)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147477195)) (= x!1 (- 2147477199))))
;            (seq.++ (seq.unit (- 2147477199)) a!5))))))))
...
;            (or (= x!1 (- 2147477195)) (= x!1 (- 2147477199))))
;          (seq.++ (seq.unit (- 2147477199))
;                  (seq.++ (seq.unit (- 2147477195)) (seq.unit (- 2147477199))))))
;(define-fun ret_33_SYMINT () Int
;  1)
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147477195)) (= x!1 (- 2147477199))))
;          (seq.++ (seq.unit (- 2147477199)) (seq.unit (- 2147477195)))))
;(define-fun List@378_7_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147477199))) (seq.unit (- 2147477199))))
