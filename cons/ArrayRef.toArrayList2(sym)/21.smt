...
;
(declare-const retMain_105_SYMOBJECT (MyList Int))
(assert (= retMain_105_SYMOBJECT List@378_102_SYMOBJECT))
;(define-fun List@378_67_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147482934))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934))
;                                   (seq.unit (- 2147482934)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482934))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482934))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147482934))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!3)))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934))) a!4))))))
;(define-fun List@378_102_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147482935))
;                   (seq.++ (seq.unit (- 2147482933))
;                           (seq.++ (seq.unit (- 2147482935))
;                                   (seq.unit (- 2147482935)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482934))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!1)))))
...
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147482934))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147482934))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!5)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147482935))
;                  (= x!1 (- 2147482934))
;                  (= x!1 (- 2147482933))))
;            (seq.++ (seq.unit (- 2147482934)) a!6)))))))))
...
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!3)))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934)))
;            (seq.++ (seq.unit (- 2147482934)) a!4)))))))
...
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!4)))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934))) a!5)))))))
...
;                           (seq.++ (seq.unit (- 2147482934))
;                                   (seq.unit (- 2147482934)))))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934))) a!1)))
...
;                           (seq.++ (seq.unit (- 2147482934)) a!4)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147482935)) (= x!1 (- 2147482934))))
;            (seq.++ (seq.unit (- 2147482934)) a!5))))))))
...
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!1)))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934))) a!2))))
...
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147482934)) a!2)))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934))) a!3)))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934)))
;          (seq.++ (seq.unit (- 2147482934))
;                  (seq.++ (seq.unit (- 2147482934)) (seq.unit (- 2147482934))))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482934))) (seq.unit (- 2147482934))))
