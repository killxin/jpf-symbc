...
;
(declare-const retMain_40_SYMOBJECT (MyList Int))
(assert (= retMain_40_SYMOBJECT List@378_37_SYMOBJECT))
;(define-fun length_24_SYMINT () Int
;  7)
;(define-fun array_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147483540))
;                   (seq.++ (seq.unit (- 2147483540))
;                           (seq.++ (seq.unit (- 2147483538))
;                                   (seq.unit (- 2147483537)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483539))
;                   (seq.++ (seq.unit (- 2147483540))
;                           (seq.++ (seq.unit (- 2147483540)) a!1)))))
...
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147483540)) (= x!1 (- 2147483539))))
;          (seq.++ (seq.unit (- 2147483539)) (seq.unit (- 2147483540)))))
...
;                  (seq.++ (seq.unit (- 2147483540)) (seq.unit (- 2147483540))))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147483539))) (seq.unit (- 2147483539))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147483539))
;                   (seq.++ (seq.unit (- 2147483540))
;                           (seq.++ (seq.unit (- 2147483540))
;                                   (seq.unit (- 2147483540)))))))
;  (List_Int (lambda ((x!1 Int))
