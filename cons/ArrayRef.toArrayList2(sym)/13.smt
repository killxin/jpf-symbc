...
;
(declare-const retMain_65_SYMOBJECT (MyList Int))
(assert (= retMain_65_SYMOBJECT List@378_62_SYMOBJECT))
;(define-fun ret_58_SYMINT () Int
;  1)
;(define-fun array_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147478034))
;                   (seq.++ (seq.unit (- 2147478032))
;                           (seq.++ (seq.unit (- 2147478033))
;                                   (seq.unit (- 2147478035)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147478034))
;                   (seq.++ (seq.unit (- 2147478037))
;                           (seq.++ (seq.unit (- 2147478040)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147478036))
;                   (seq.++ (seq.unit (- 2147478039))
;                           (seq.++ (seq.unit (- 2147478039)) a!2)))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478040))
;                   (seq.++ (seq.unit (- 2147478034))
;                           (seq.++ (seq.unit (- 2147478032))
;                                   (seq.unit (- 2147478033)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147478039))
;                   (seq.++ (seq.unit (- 2147478034))
;                           (seq.++ (seq.unit (- 2147478037)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147478036))
;                   (seq.++ (seq.unit (- 2147478036))
;                           (seq.++ (seq.unit (- 2147478039)) a!2)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147478036))
;                  (= x!1 (- 2147478039))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478039))
;                   (seq.++ (seq.unit (- 2147478036))
;                           (seq.++ (seq.unit (- 2147478036))
;                                   (seq.unit (- 2147478039)))))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147478036)) (= x!1 (- 2147478039))))
;            a!1)))
...
;                                   (seq.unit (- 2147478034)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147478036))
;                   (seq.++ (seq.unit (- 2147478039))
;                           (seq.++ (seq.unit (- 2147478039)) a!1)))))
;  (List_Int (_ as-array k!190)
;            (seq.++ (seq.unit (- 2147478039))
;                    (seq.++ (seq.unit (- 2147478036)) a!2))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478037))
;                   (seq.++ (seq.unit (- 2147478040))
;                           (seq.++ (seq.unit (- 2147478034))
;                                   (seq.unit (- 2147478032)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147478039))
;                   (seq.++ (seq.unit (- 2147478039))
;                           (seq.++ (seq.unit (- 2147478034)) a!1)))))
...
;            (or (= x!1 (- 2147478036)) (= x!1 (- 2147478039))))
;          (seq.++ (seq.unit (- 2147478039))
;                  (seq.++ (seq.unit (- 2147478036)) (seq.unit (- 2147478036))))))
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147478036)) (= x!1 (- 2147478039))))
;          (seq.++ (seq.unit (- 2147478039)) (seq.unit (- 2147478036)))))
;(define-fun ret_33_SYMINT () Int
;  1)
;(define-fun List@378_7_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147478039))) (seq.unit (- 2147478039))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478036))
;                   (seq.++ (seq.unit (- 2147478039))
;                           (seq.++ (seq.unit (- 2147478039))
;                                   (seq.unit (- 2147478034)))))))
;  (List_Int (lambda ((x!1 Int))
...
;                   (seq.++ (seq.unit (- 2147478036))
;                           (seq.++ (seq.unit (- 2147478039)) a!1)))))
;  (List_Int (_ as-array k!190) (seq.++ (seq.unit (- 2147478039)) a!2)))))
