...
;
(declare-const retMain_50_SYMOBJECT (MyList Int))
(assert (= retMain_50_SYMOBJECT List@378_47_SYMOBJECT))
;(define-fun length_24_SYMINT () Int
;  9)
;(define-fun array_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit 12)
;                   (seq.++ (seq.unit (- 2733))
;                           (seq.++ (seq.unit 13) (seq.unit 11))))))
;(let ((a!2 (seq.++ (seq.unit (- 2733))
;                   (seq.++ (seq.unit 12) (seq.++ (seq.unit (- 2971)) a!1)))))
...
;                  (= x!1 1)
;                  (= x!1 96)))
;            (seq.++ (seq.unit (- 2147482552)) (seq.++ (seq.unit 13) a!2))))))
;(define-fun List@378_37_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit 12)
;                   (seq.++ (seq.unit (- 2971))
;                           (seq.++ (seq.unit 12) (seq.unit (- 2733)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482552))
;                   (seq.++ (seq.unit 13) (seq.++ (seq.unit (- 2733)) a!1)))))
;  (List_Int (_ as-array k!127) a!2))))
;(define-fun length_34_SYMINT () Int
;  9)
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 13) (= x!1 (- 2147482552))))
;          (seq.++ (seq.unit (- 2147482552)) (seq.unit 13))))
;(define-fun ret_43_SYMINT () Int
;  1)
;(define-fun List@378_17_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 13) (= x!1 (- 2147482552)) (= x!1 (- 2733))))
;          (seq.++ (seq.unit (- 2147482552))
;                  (seq.++ (seq.unit 13) (seq.unit (- 2733))))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482552))) (seq.unit (- 2147482552))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2733))
;                   (seq.++ (seq.unit 12)
;                           (seq.++ (seq.unit (- 2971)) (seq.unit 12))))))
;  (List_Int (_ as-array k!127)
;            (seq.++ (seq.unit (- 2147482552)) (seq.++ (seq.unit 13) a!1)))))
...
;                   (seq.++ (seq.unit (- 2733))
;                           (seq.++ (seq.unit 12) (seq.unit (- 2971)))))))
;  (List_Int (_ as-array k!127) (seq.++ (seq.unit (- 2147482552)) a!1))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2971))
;                   (seq.++ (seq.unit 12)
;                           (seq.++ (seq.unit (- 2733)) (seq.unit 13))))))
;(let ((a!2 (seq.++ (seq.unit 13)
;                   (seq.++ (seq.unit (- 2733)) (seq.++ (seq.unit 12) a!1)))))
;  (List_Int (_ as-array k!127) (seq.++ (seq.unit (- 2147482552)) a!2)))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147482552))
;                   (seq.++ (seq.unit 13)
;                           (seq.++ (seq.unit (- 2733)) (seq.unit 12))))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 13) (= x!1 12) (= x!1 (- 2147482552)) (= x!1 (- 2733))))
;            a!1)))
