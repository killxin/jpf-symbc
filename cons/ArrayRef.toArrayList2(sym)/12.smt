...
;
(declare-const retMain_60_SYMOBJECT (MyList Int))
(assert (= retMain_60_SYMOBJECT List@378_57_SYMOBJECT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478123))
;                   (seq.++ (seq.unit (- 2147478123))
;                           (seq.++ (seq.unit (- 2147478120))
;                                   (seq.unit (- 2147478124)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147478123))
;                   (seq.++ (seq.unit (- 2147478123))
;                           (seq.++ (seq.unit (- 2147478123)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147478123))
;                   (seq.++ (seq.unit (- 2147478123))
;                           (seq.++ (seq.unit (- 2147478123)) a!2)))))
...
;                   (seq.++ (seq.unit (- 2147478123))
;                           (seq.++ (seq.unit (- 2147478123)) a!1)))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147478123))) a!2))))
...
;                           (seq.++ (seq.unit (- 2147478123)) a!2)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147478120)) (= x!1 (- 2147478123))))
;            a!3)))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147478123)))
;          (seq.++ (seq.unit (- 2147478123))
;                  (seq.++ (seq.unit (- 2147478123)) (seq.unit (- 2147478123))))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147478123))) (seq.unit (- 2147478123))))
...
;                           (seq.++ (seq.unit (- 2147478123))
;                                   (seq.unit (- 2147478123)))))))
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147478123))) a!1)))
