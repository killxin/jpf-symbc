...
;
(declare-const retMain_85_SYMOBJECT (MyList Int))
(assert (= retMain_85_SYMOBJECT List@378_82_SYMOBJECT))
;(define-fun List@378_67_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972)
;                           (seq.++ (seq.unit (- 2147470106)) (seq.unit 8972))))))
;(let ((a!2 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8973) a!1)))))
;(let ((a!3 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8972) a!2)))))
;(let ((a!4 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!3)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147470106)) (= x!1 8972) (= x!1 8973)))
;            a!4))))))
;(define-fun List@378_72_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit (- 2147470106))
;                           (seq.++ (seq.unit 8972) (seq.unit 8971))))))
;(let ((a!2 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8972) a!1)))))
;(let ((a!3 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!2)))))
;(let ((a!4 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!3)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147470106)) (= x!1 8972) (= x!1 8973) (= x!1 8971)))
;            (seq.++ (seq.unit 8973) a!4)))))))
;(define-fun ret_58_SYMINT () Int
;  1)
;(define-fun array_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8971)
;                           (seq.++ (seq.unit 8974) (seq.unit (- 2147470238)))))))
;(let ((a!2 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972)
;                           (seq.++ (seq.unit (- 2147470106)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8973) a!2)))))
;(let ((a!4 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8972) a!3)))))
;(let ((a!5 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!4)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 246)
;                  (= x!1 (- 9))
;                  (= x!1 8974)
...
;  (let ((a!1 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8973)
;                           (seq.++ (seq.unit 8972) (seq.unit 8972))))))
;(let ((a!2 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!1)))))
;(let ((a!3 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!2)))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 8972) (= x!1 8973)))
;            (seq.++ (seq.unit 8973) a!3))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147470106))
;                   (seq.++ (seq.unit 8972)
;                           (seq.++ (seq.unit 8971) (seq.unit 8974))))))
;(let ((a!2 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!1)))))
;(let ((a!3 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8973) a!2)))))
;(let ((a!4 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8973) a!3)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147470106))
;                  (= x!1 8974)
;                  (= x!1 8972)
;                  (= x!1 8973)
;                  (= x!1 8971)))
;            (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8972) a!4))))))))
...
;                   (seq.++ (seq.unit 8972)
;                           (seq.++ (seq.unit 8972) (seq.unit 8972))))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 8972) (= x!1 8973))) a!1)))
...
;  (let ((a!1 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972)
;                           (seq.++ (seq.unit 8973) (seq.unit 8973))))))
;(let ((a!2 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8973) a!1)))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 8972) (= x!1 8973)))
;            (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8972) a!2))))))
...
;(let ((a!2 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!1)))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 8972) (= x!1 8973))) a!2))))
;(define-fun ret_66_SYMINT () Int
;  8972)
;(define-fun List@378_62_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972)
;                           (seq.++ (seq.unit 8972) (seq.unit (- 2147470106)))))))
;(let ((a!2 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8973) a!1)))))
;(let ((a!3 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8973) a!2)))))
...
;  (let ((a!1 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8973)
;                           (seq.++ (seq.unit 8973) (seq.unit 8972))))))
;(let ((a!2 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8972) a!1)))))
;(let ((a!3 (seq.++ (seq.unit 8973)
;                   (seq.++ (seq.unit 8972) (seq.++ (seq.unit 8972) a!2)))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 8972) (= x!1 8973))) a!3)))))
...
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 8972) (= x!1 8973)))
;          (seq.++ (seq.unit 8973) (seq.++ (seq.unit 8972) (seq.unit 8972)))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 8973)) (seq.unit 8973)))
...
;  (let ((a!1 (seq.++ (seq.unit 8972)
;                   (seq.++ (seq.unit 8972)
;                           (seq.++ (seq.unit 8972) (seq.unit 8973))))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 8972) (= x!1 8973)))
;            (seq.++ (seq.unit 8973) a!1))))
