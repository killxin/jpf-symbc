...
;
(declare-const retMain_75_SYMOBJECT (MyList Int))
(assert (= retMain_75_SYMOBJECT List@378_72_SYMOBJECT))
;(define-fun List@378_67_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147482043))
;                   (seq.++ (seq.unit (- 2147482045))
;                           (seq.++ (seq.unit (- 2147482043))
;                                   (seq.unit (- 2147482043)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482043))
;                   (seq.++ (seq.unit (- 2147482042))
;                           (seq.++ (seq.unit (- 2147482043)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482043))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147482045))
;                   (seq.++ (seq.unit (- 2147482042))
;                           (seq.++ (seq.unit (- 2147482044)) a!3)))))
;  (List_Int (_ as-array k!226) a!4))))))
;(define-fun List@378_72_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147482045))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043))
;                                   (seq.unit (- 2147482044)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482042))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482043))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147482042))
;                   (seq.++ (seq.unit (- 2147482044))
;                           (seq.++ (seq.unit (- 2147482043)) a!3)))))
;  (List_Int (_ as-array k!226) (seq.++ (seq.unit (- 2147482045)) a!4)))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147482042))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043))
;                                   (seq.unit (- 2147482045)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482043))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482042))
;                   (seq.++ (seq.unit (- 2147482044))
;                           (seq.++ (seq.unit (- 2147482043)) a!2)))))
;  (List_Int (_ as-array k!226) (seq.++ (seq.unit (- 2147482045)) a!3))))))
...
;                           (seq.++ (seq.unit (- 2147482042))
;                                   (seq.unit (- 2147482043)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482044))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043)) a!1)))))
;  (List_Int (_ as-array k!226)
;            (seq.++ (seq.unit (- 2147482045))
;                    (seq.++ (seq.unit (- 2147482042)) a!2))))))
...
;                           (seq.++ (seq.unit (- 2147482043))
;                                   (seq.unit (- 2147482043)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482045))
;                   (seq.++ (seq.unit (- 2147482042))
;                           (seq.++ (seq.unit (- 2147482044)) a!1)))))
;  (List_Int (_ as-array k!226) a!2))))
...
;(let ((a!2 (seq.++ (seq.unit (- 2147482043))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482042)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482044))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043)) a!2)))))
;  (List_Int (_ as-array k!226)
;            (seq.++ (seq.unit (- 2147482045))
;                    (seq.++ (seq.unit (- 2147482042)) a!3)))))))
...
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482045))
;                   (seq.++ (seq.unit (- 2147482042))
;                           (seq.++ (seq.unit (- 2147482044)) a!2)))))
;  (List_Int (_ as-array k!226) a!3)))))
...
;                (= x!1 (- 2147482044))))
;          (seq.++ (seq.unit (- 2147482045))
;                  (seq.++ (seq.unit (- 2147482042)) (seq.unit (- 2147482044))))))
;(define-fun ret_33_SYMINT () Int
;  1)
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147482042)) (= x!1 (- 2147482045))))
;          (seq.++ (seq.unit (- 2147482045)) (seq.unit (- 2147482042)))))
;(define-fun List@378_7_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147482045))) (seq.unit (- 2147482045))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147482044))
;                   (seq.++ (seq.unit (- 2147482043))
;                           (seq.++ (seq.unit (- 2147482043))
;                                   (seq.unit (- 2147482043)))))))
;  (List_Int (_ as-array k!226)
...
;                           (seq.++ (seq.unit (- 2147482043))
;                                   (seq.unit (- 2147482043)))))))
;  (List_Int (_ as-array k!226) (seq.++ (seq.unit (- 2147482045)) a!1))))
...
;                   (seq.++ (seq.unit (- 2147482044))
;                           (seq.++ (seq.unit (- 2147482043)) a!1)))))
;  (List_Int (_ as-array k!226) (seq.++ (seq.unit (- 2147482045)) a!2)))))
