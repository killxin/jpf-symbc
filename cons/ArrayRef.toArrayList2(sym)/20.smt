...
;
(declare-const retMain_100_SYMOBJECT (MyList Int))
(assert (= retMain_100_SYMOBJECT List@378_97_SYMOBJECT))
;(define-fun List@378_67_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147481822))
;                   (seq.++ (seq.unit (- 2147481815))
;                           (seq.++ (seq.unit (- 2147481824))
;                                   (seq.unit (- 2147481829)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481827))
;                   (seq.++ (seq.unit (- 2147481824))
;                           (seq.++ (seq.unit (- 2147481823)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481822)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481828))
;                   (seq.++ (seq.unit (- 2147481821))
;                           (seq.++ (seq.unit (- 2147481822)) a!3)))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481815))
;                   (seq.++ (seq.unit (- 2147481824))
;                           (seq.++ (seq.unit (- 2147481829))
;                                   (seq.unit (- 2147481819)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481824))
;                   (seq.++ (seq.unit (- 2147481823))
;                           (seq.++ (seq.unit (- 2147481822)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481827)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481821))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481831)) a!3)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147481821))
;                  (= x!1 (- 2147481831))
;                  (= x!1 (- 2147481823))
...
;                  (= x!1 (- 2147481822))
;                  (= x!1 (- 2147481819))))
;            (seq.++ (seq.unit (- 2147481828)) a!4)))))))
;(define-fun ret_58_SYMINT () Int
;  1)
;(define-fun array_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147481826))
;                   (seq.++ (seq.unit (- 2147481824))
;                           (seq.++ (seq.unit (- 2147481829))
;                                   (seq.unit (- 2147481815)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481829))
;                   (seq.++ (seq.unit (- 2147481819))
;                           (seq.++ (seq.unit (- 2147481820)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481822))
;                   (seq.++ (seq.unit (- 2147481815))
;                           (seq.++ (seq.unit (- 2147481824)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481827))
;                   (seq.++ (seq.unit (- 2147481824))
;                           (seq.++ (seq.unit (- 2147481823)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481822)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147481828))
;                   (seq.++ (seq.unit (- 2147481821))
;                           (seq.++ (seq.unit (- 2147481822)) a!5)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 7)
;                  (= x!1 (- 11))
;                  (= x!1 (- 6))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481829))
;                   (seq.++ (seq.unit (- 2147481819))
;                           (seq.++ (seq.unit (- 2147481820))
;                                   (seq.unit (- 2147481826)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481822))
;                   (seq.++ (seq.unit (- 2147481815))
;                           (seq.++ (seq.unit (- 2147481824)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481827))
;                   (seq.++ (seq.unit (- 2147481824))
;                           (seq.++ (seq.unit (- 2147481823)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481822)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147481828))
;                   (seq.++ (seq.unit (- 2147481821))
;                           (seq.++ (seq.unit (- 2147481822)) a!4)))))
;  (List_Int (_ as-array k!307) a!5)))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481820))
;                   (seq.++ (seq.unit (- 2147481826))
;                           (seq.++ (seq.unit (- 2147481824))
;                                   (seq.unit (- 2147481829)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481824))
;                   (seq.++ (seq.unit (- 2147481829))
;                           (seq.++ (seq.unit (- 2147481819)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481823))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481815)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481822))
;                   (seq.++ (seq.unit (- 2147481827))
;                           (seq.++ (seq.unit (- 2147481824)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147481822))
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481831)) a!4)))))
;  (List_Int (_ as-array k!307)
;            (seq.++ (seq.unit (- 2147481828))
;                    (seq.++ (seq.unit (- 2147481821)) a!5)))))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481824))
;                   (seq.++ (seq.unit (- 2147481823))
;                           (seq.++ (seq.unit (- 2147481822))
;                                   (seq.unit (- 2147481815)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481827)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481821))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481831)) a!2)))))
;  (List_Int (_ as-array k!311) (seq.++ (seq.unit (- 2147481828)) a!3))))))
...
;                           (seq.++ (seq.unit (- 2147481819))
;                                   (seq.unit (- 2147481820)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481823))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481815)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481822))
;                   (seq.++ (seq.unit (- 2147481827))
;                           (seq.++ (seq.unit (- 2147481824)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481822))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481828))
;                   (seq.++ (seq.unit (- 2147481821))
;                           (seq.++ (seq.unit (- 2147481822))
;                                   (seq.unit (- 2147481831)))))))
;  (List_Int (_ as-array k!315) a!1)))
;(define-fun List@378_87_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147481819))
;                   (seq.++ (seq.unit (- 2147481820))
;                           (seq.++ (seq.unit (- 2147481826))
;                                   (seq.unit (- 2147481824)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481815))
;                   (seq.++ (seq.unit (- 2147481824))
;                           (seq.++ (seq.unit (- 2147481829)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481824))
;                   (seq.++ (seq.unit (- 2147481823))
;                           (seq.++ (seq.unit (- 2147481822)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481827)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147481821))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481831)) a!4)))))
;  (List_Int (_ as-array k!307) (seq.++ (seq.unit (- 2147481828)) a!5))))))))
...
;(let ((a!2 (seq.++ (seq.unit (- 2147481822))
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481831)) a!1)))))
;  (List_Int (_ as-array k!312)
;            (seq.++ (seq.unit (- 2147481828))
;                    (seq.++ (seq.unit (- 2147481821)) a!2))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481822))
;                                   (seq.unit (- 2147481827)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481828))
;                   (seq.++ (seq.unit (- 2147481821))
;                           (seq.++ (seq.unit (- 2147481822)) a!1)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147481821))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481823))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481815))
;                                   (seq.unit (- 2147481824)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481822))
...
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481831)) a!2)))))
;  (List_Int (_ as-array k!311)
;            (seq.++ (seq.unit (- 2147481828))
;                    (seq.++ (seq.unit (- 2147481821)) a!3)))))))
;(define-fun List@378_52_SYMOBJECT () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147481827))
;                   (seq.++ (seq.unit (- 2147481824))
;                           (seq.++ (seq.unit (- 2147481823))
;                                   (seq.unit (- 2147481822)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481831))
;                   (seq.++ (seq.unit (- 2147481831))
;                           (seq.++ (seq.unit (- 2147481822)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481828))
;                   (seq.++ (seq.unit (- 2147481821))
;                           (seq.++ (seq.unit (- 2147481822)) a!2)))))
;  (List_Int (_ as-array k!312) a!3)))))
...
;                (= x!1 (- 2147481822))))
;          (seq.++ (seq.unit (- 2147481828))
;                  (seq.++ (seq.unit (- 2147481821)) (seq.unit (- 2147481822))))))
;(define-fun ret_33_SYMINT () Int
;  1)
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147481821)) (= x!1 (- 2147481828))))
;          (seq.++ (seq.unit (- 2147481828)) (seq.unit (- 2147481821)))))
;(define-fun List@378_7_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147481828))) (seq.unit (- 2147481828))))
...
;                           (seq.++ (seq.unit (- 2147481831))
;                                   (seq.unit (- 2147481822)))))))
;  (List_Int (_ as-array k!315)
;            (seq.++ (seq.unit (- 2147481828))
;                    (seq.++ (seq.unit (- 2147481821)) a!1)))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481821))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481831))
;                                   (seq.unit (- 2147481831)))))))
;  (List_Int (_ as-array k!315) (seq.++ (seq.unit (- 2147481828)) a!1))))
...
;                           (seq.++ (seq.unit (- 2147481827))
;                                   (seq.unit (- 2147481824)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481821))
;                   (seq.++ (seq.unit (- 2147481822))
;                           (seq.++ (seq.unit (- 2147481831)) a!1)))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147481821))
...
;      (= x!0 (- 2147481815))
;      (= x!0 (- 2147481822))))
;(define-fun k!315 ((x!0 Int)) Bool
;  (or (= x!0 (- 2147481821))
;      (= x!0 (- 2147481831))
;      (= x!0 (- 2147481828))
;      (= x!0 (- 2147481822))))
;(define-fun k!307 ((x!0 Int)) Bool
;  (or (= x!0 (- 2147481821))
;      (= x!0 (- 2147481831))
;      (= x!0 (- 2147481823))
;      (= x!0 (- 2147481824))
