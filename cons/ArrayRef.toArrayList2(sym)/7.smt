...
;
(declare-const retMain_35_SYMOBJECT (MyList Int))
(assert (= retMain_35_SYMOBJECT List@378_32_SYMOBJECT))
;(define-fun length_24_SYMINT () Int
;  6)
;(define-fun array_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147480013))
;                   (seq.++ (seq.unit (- 2147480011))
;                           (seq.++ (seq.unit (- 2147480010))
;                                   (seq.unit (- 2147480014)))))))
...
;                  (= x!1 (- 2147480011))
;                  (= x!1 (- 2))))
;            (seq.++ (seq.unit (- 2147480012))
;                    (seq.++ (seq.unit (- 2147480009)) a!1)))))
;(define-fun length_34_SYMINT () Int
;  6)
;(define-fun List@378_12_SYMOBJECT () List_Int
;  (List_Int (lambda ((x!1 Int))
;            (or (= x!1 (- 2147480009)) (= x!1 (- 2147480012))))
;          (seq.++ (seq.unit (- 2147480012)) (seq.unit (- 2147480009)))))
...
;                (= x!1 (- 2147480013))))
;          (seq.++ (seq.unit (- 2147480012))
;                  (seq.++ (seq.unit (- 2147480009)) (seq.unit (- 2147480013))))))
...
;  (List_Int (lambda ((x!1 Int)) (= x!1 (- 2147480012))) (seq.unit (- 2147480012))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147480009))
;                   (seq.++ (seq.unit (- 2147480013))
;                           (seq.++ (seq.unit (- 2147480011))
;                                   (seq.unit (- 2147480010)))))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147480009))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147480012))
;                   (seq.++ (seq.unit (- 2147480009))
;                           (seq.++ (seq.unit (- 2147480013))
;                                   (seq.unit (- 2147480011)))))))
;  (List_Int (lambda ((x!1 Int))
;              (or (= x!1 (- 2147480009))
