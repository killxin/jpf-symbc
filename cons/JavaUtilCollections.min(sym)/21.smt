...
(declare-fun ret@Iterator_57_SYMOBJECT () (MyIterator Int))
(declare-fun ret@Iterator_54_SYMOBJECT () (MyIterator Int))
(declare-fun ret@Iterator_60_SYMOBJECT () (MyIterator Int))
...
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_60_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_60_SYMOBJECT) x))))))
  (= ret_65_SYMINT (ite a!1 1 0)))
(and (= true (select (mapping ret@Iterator_57_SYMOBJECT) ret_61_SYMINT))
     (= false (select (previous ret@Iterator_57_SYMOBJECT) ret_61_SYMINT))
     (= (mapping ret@Iterator_60_SYMOBJECT) (mapping ret@Iterator_57_SYMOBJECT))
     (= (previous ret@Iterator_60_SYMOBJECT)
        (store (previous ret@Iterator_57_SYMOBJECT) ret_61_SYMINT true)))
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_57_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_57_SYMOBJECT) x))))))
  (= ret_59_SYMINT (ite a!1 1 0)))
(and (= true (select (mapping ret@Iterator_54_SYMOBJECT) ret_58_SYMINT))
     (= false (select (previous ret@Iterator_54_SYMOBJECT) ret_58_SYMINT))
     (= (mapping ret@Iterator_57_SYMOBJECT) (mapping ret@Iterator_54_SYMOBJECT))
     (= (previous ret@Iterator_57_SYMOBJECT)
        (store (previous ret@Iterator_54_SYMOBJECT) ret_58_SYMINT true)))
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_54_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_54_SYMOBJECT) x))))))
  (= ret_56_SYMINT (ite a!1 1 0)))
