...
(declare-fun ret@Iterator_69_SYMOBJECT () (MyIterator Int))
...
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_69_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_69_SYMOBJECT) x))))))
  (= ret_74_SYMINT (ite a!1 1 0)))
(and (= true (select (mapping ret@Iterator_57_SYMOBJECT) ret_70_SYMINT))
     (= false (select (previous ret@Iterator_57_SYMOBJECT) ret_70_SYMINT))
     (= (mapping ret@Iterator_69_SYMOBJECT) (mapping ret@Iterator_57_SYMOBJECT))
     (= (previous ret@Iterator_69_SYMOBJECT)
        (store (previous ret@Iterator_57_SYMOBJECT) ret_70_SYMINT true)))
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_57_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_57_SYMOBJECT) x))))))
  (= ret_68_SYMINT (ite a!1 1 0)))
