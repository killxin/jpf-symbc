...
(declare-fun ret@Iterator_36_SYMOBJECT () (MyIterator Int))
...
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_36_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_36_SYMOBJECT) x))))))
  (= ret_38_SYMINT (ite a!1 1 0)))
(and (= true (select (mapping ret@Iterator_33_SYMOBJECT) ret_37_SYMINT))
     (= false (select (previous ret@Iterator_33_SYMOBJECT) ret_37_SYMINT))
     (= (mapping ret@Iterator_36_SYMOBJECT) (mapping ret@Iterator_33_SYMOBJECT))
     (= (previous ret@Iterator_36_SYMOBJECT)
        (store (previous ret@Iterator_33_SYMOBJECT) ret_37_SYMINT true)))
(let ((a!1 (exists ((x Int))
