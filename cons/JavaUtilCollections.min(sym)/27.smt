...
(declare-fun ret@Iterator_81_SYMOBJECT () (MyIterator Int))
...
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_81_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_81_SYMOBJECT) x))))))
  (= ret_83_SYMINT (ite a!1 1 0)))
(and (= true (select (mapping ret@Iterator_78_SYMOBJECT) ret_82_SYMINT))
     (= false (select (previous ret@Iterator_78_SYMOBJECT) ret_82_SYMINT))
     (= (mapping ret@Iterator_81_SYMOBJECT) (mapping ret@Iterator_78_SYMOBJECT))
     (= (previous ret@Iterator_81_SYMOBJECT)
        (store (previous ret@Iterator_78_SYMOBJECT) ret_82_SYMINT true)))
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_78_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_78_SYMOBJECT) x))))))
  (= ret_80_SYMINT (ite a!1 1 0)))
