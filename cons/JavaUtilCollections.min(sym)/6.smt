...
(declare-fun ret@Iterator_15_SYMOBJECT () (MyIterator Int))
...
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_15_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_15_SYMOBJECT) x))))))
  (= ret_20_SYMINT (ite a!1 1 0)))
(and (= true (select (mapping ret@Iterator_12_SYMOBJECT) ret_16_SYMINT))
     (= false (select (previous ret@Iterator_12_SYMOBJECT) ret_16_SYMINT))
     (= (mapping ret@Iterator_15_SYMOBJECT) (mapping ret@Iterator_12_SYMOBJECT))
     (= (previous ret@Iterator_15_SYMOBJECT)
        (store (previous ret@Iterator_12_SYMOBJECT) ret_16_SYMINT true)))
(let ((a!1 (exists ((x Int))
             (and (= true (select (mapping ret@Iterator_12_SYMOBJECT) x))
                  (= false (select (previous ret@Iterator_12_SYMOBJECT) x))))))
  (= ret_14_SYMINT (ite a!1 1 0)))
