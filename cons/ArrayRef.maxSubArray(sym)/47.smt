...
;
(declare-const retMain_143_SYMINT Int)
(assert (= retMain_143_SYMINT ret_141_SYMINT))
...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147480503))
;                   (seq.++ (seq.unit (- 2147475668))
;                           (seq.++ (seq.unit (- 2147475667))
;                                   (seq.unit (- 2147475666)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483468))
;                   (seq.++ (seq.unit (- 2147483120))
;                           (seq.++ (seq.unit (- 2147481742)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483576))
;                   (seq.++ (seq.unit (- 2147483533))
;                           (seq.++ (seq.unit (- 2147483482)) a!3)))))
...
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483639)) a!16))))))))))))))))))
