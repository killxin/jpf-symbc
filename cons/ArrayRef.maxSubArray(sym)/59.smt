...
;
(declare-const retMain_179_SYMINT Int)
(assert (= retMain_179_SYMINT ret_177_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147483468))
;                   (seq.++ (seq.unit (- 2147479202))
;                           (seq.++ (seq.unit (- 2147479201))
;                                   (seq.unit (- 2147479200)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483577))
;                   (seq.++ (seq.unit (- 2147483549))
;                           (seq.++ (seq.unit (- 2147483481)) a!1)))))
