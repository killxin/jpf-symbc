...
;
(declare-const retMain_125_SYMINT Int)
(assert (= retMain_125_SYMINT ret_123_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147483415))
;                   (seq.++ (seq.unit (- 2147483264))
;                           (seq.++ (seq.unit (- 2147483263))
;                                   (seq.unit (- 2147483262)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483613))
;                   (seq.++ (seq.unit (- 2147483611))
;                           (seq.++ (seq.unit (- 2147483600)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483616))
;                   (seq.++ (seq.unit (- 2147483615))
;                           (seq.++ (seq.unit (- 2147483614)) a!2)))))
