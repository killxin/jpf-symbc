...
;
(declare-const retMain_161_SYMINT Int)
(assert (= retMain_161_SYMINT ret_159_SYMINT))
...
;                  (not (= x!1 (- 7)))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147483273))
;                   (seq.++ (seq.unit (- 2147479091))
;                           (seq.++ (seq.unit (- 2147479090))
;                                   (seq.unit (- 2147479089)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483558))
;                   (seq.++ (seq.unit (- 2147483551))
;                           (seq.++ (seq.unit (- 2147483292)) a!2)))))
...
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483641)) a!18))))))))))))))))))))
