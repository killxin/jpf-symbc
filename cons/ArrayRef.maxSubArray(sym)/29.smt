...
(assert (= retMain_89_SYMINT ret_87_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147482030))
;                   (seq.++ (seq.unit (- 2147474263))
;                           (seq.++ (seq.unit (- 2147474262))
;                                   (seq.unit (- 2147474261)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483285))
;                   (seq.++ (seq.unit (- 2147482399))
;                           (seq.++ (seq.unit (- 2147482327)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483628))
;                   (seq.++ (seq.unit (- 2147483622))
;                           (seq.++ (seq.unit (- 2147483563)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483631))
;                   (seq.++ (seq.unit (- 2147483630))
;                           (seq.++ (seq.unit (- 2147483629)) a!3)))))
