...
;  (let ((a!1 (seq.++ (seq.unit (- 2147475048))
;                   (seq.++ (seq.unit (- 2147474583))
;                           (seq.++ (seq.unit (- 2147474582))
;                                   (seq.unit (- 2147474581)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482459))
;                   (seq.++ (seq.unit (- 2147481944))
;                           (seq.++ (seq.unit (- 2147476232)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483558))
;                   (seq.++ (seq.unit (- 2147483333))
;                           (seq.++ (seq.unit (- 2147483332)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483635))
;                   (seq.++ (seq.unit (- 2147483628))
;                           (seq.++ (seq.unit (- 2147483625)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483638))
;                   (seq.++ (seq.unit (- 2147483637))
;                           (seq.++ (seq.unit (- 2147483636)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483641))
;                   (seq.++ (seq.unit (- 2147483640))
;                           (seq.++ (seq.unit (- 2147483639)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483644))
;                   (seq.++ (seq.unit (- 2147483643))
;                           (seq.++ (seq.unit (- 2147483642)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483647))
;                   (seq.++ (seq.unit (- 2147483646))
;                           (seq.++ (seq.unit (- 2147483645)) a!7)))))
