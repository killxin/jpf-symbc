...
(assert (= retMain_185_SYMINT ret_183_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481936))
;                   (seq.++ (seq.unit (- 2147479006))
;                           (seq.++ (seq.unit (- 2147479005))
;                                   (seq.unit (- 2147479004)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483455))
;                   (seq.++ (seq.unit (- 2147483332))
;                           (seq.++ (seq.unit (- 2147483313)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483593))
;                   (seq.++ (seq.unit (- 2147483588))
;                           (seq.++ (seq.unit (- 2147483541)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483596))
;                   (seq.++ (seq.unit (- 2147483595))
;                           (seq.++ (seq.unit (- 2147483594)) a!3)))))
...
;              (or (= x!1 8) (= x!1 (- 4)) (= x!1 10) (= x!1 (- 11)) (= x!1 3)))
;            a!20))))))))))))))))))))))
