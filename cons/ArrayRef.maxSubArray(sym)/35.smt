...
;
(declare-const retMain_107_SYMINT Int)
(assert (= retMain_107_SYMINT ret_105_SYMINT))
...
;                  (not (= x!1 1))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147481540))
;                   (seq.++ (seq.unit (- 2147479274))
;                           (seq.++ (seq.unit (- 2147479273))
;                                   (seq.unit (- 2147479272)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483470))
;                   (seq.++ (seq.unit (- 2147482934))
;                           (seq.++ (seq.unit (- 2147481566)) a!2)))))
...
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483645)) a!12))))))))))))))
