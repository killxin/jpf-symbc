...
(assert (= retMain_35_SYMINT ret_33_SYMINT))
;(define-fun length_13_SYMINT () Int
;  11)
;(define-fun length_2_SYMINT () Int
;  11)
;(define-fun nums_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147483221))
;                   (seq.++ (seq.unit (- 2147480383))
;                           (seq.++ (seq.unit (- 2147480382))
;                                   (seq.unit (- 2147480381)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483639))
;                   (seq.++ (seq.unit (- 2147483637))
;                           (seq.++ (seq.unit (- 2147483601)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483646))
;                   (seq.++ (seq.unit (- 2147483645))
;                           (seq.++ (seq.unit (- 2147483642)) a!2)))))
