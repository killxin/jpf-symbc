...
;  (let ((a!1 (seq.++ (seq.unit (- 2147480583))
;                   (seq.++ (seq.unit (- 2147477866))
;                           (seq.++ (seq.unit (- 2147477865))
;                                   (seq.unit (- 2147477864)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483252))
;                   (seq.++ (seq.unit (- 2147482268))
;                           (seq.++ (seq.unit (- 2147482039)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483564))
;                   (seq.++ (seq.unit (- 2147483535))
;                           (seq.++ (seq.unit (- 2147483464)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483593))
;                   (seq.++ (seq.unit (- 2147483590))
;                           (seq.++ (seq.unit (- 2147483584)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483596))
;                   (seq.++ (seq.unit (- 2147483595))
;                           (seq.++ (seq.unit (- 2147483594)) a!4)))))
