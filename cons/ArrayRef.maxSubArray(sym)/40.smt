...
;
(declare-const retMain_122_SYMINT Int)
(assert (= retMain_122_SYMINT ret_120_SYMINT))
...
;                  (not (= x!1 (- 11)))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147478243))
;                   (seq.++ (seq.unit (- 2147474908))
;                           (seq.++ (seq.unit (- 2147474907))
;                                   (seq.unit (- 2147474906)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483409))
;                   (seq.++ (seq.unit (- 2147483113))
;                           (seq.++ (seq.unit (- 2147480820)) a!2)))))
