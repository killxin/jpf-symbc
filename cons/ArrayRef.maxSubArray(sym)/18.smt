...
;
(declare-const retMain_56_SYMINT Int)
(assert (= retMain_56_SYMINT ret_54_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147480918))
;                   (seq.++ (seq.unit (- 2147479793))
;                           (seq.++ (seq.unit (- 2147479792))
;                                   (seq.unit (- 2147479791)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483608))
;                   (seq.++ (seq.unit (- 2147483588))
;                           (seq.++ (seq.unit (- 2147483421)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483628))
;                   (seq.++ (seq.unit (- 2147483627))
;                           (seq.++ (seq.unit (- 2147483620)) a!2)))))
