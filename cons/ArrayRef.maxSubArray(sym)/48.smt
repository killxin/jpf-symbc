...
;
(declare-const retMain_146_SYMINT Int)
(assert (= retMain_146_SYMINT ret_144_SYMINT))
...
;                  (not (= x!1 3))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147475888))
;                   (seq.++ (seq.unit (- 2147474277))
;                           (seq.++ (seq.unit (- 2147474276))
;                                   (seq.unit (- 2147474275)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147479535))
;                   (seq.++ (seq.unit (- 2147479506))
;                           (seq.++ (seq.unit (- 2147476912)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483587))
;                   (seq.++ (seq.unit (- 2147483156))
;                           (seq.++ (seq.unit (- 2147482770)) a!3)))))
