...
;
(declare-const retMain_101_SYMINT Int)
(assert (= retMain_101_SYMINT ret_99_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147479031))
;                   (seq.++ (seq.unit (- 2147474360))
;                           (seq.++ (seq.unit (- 2147474359))
;                                   (seq.unit (- 2147474358)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483588))
;                   (seq.++ (seq.unit (- 2147483221))
;                           (seq.++ (seq.unit (- 2147482460)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483623))
;                   (seq.++ (seq.unit (- 2147483622))
;                           (seq.++ (seq.unit (- 2147483606)) a!2)))))
