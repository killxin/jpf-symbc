...
(assert (= retMain_71_SYMINT ret_69_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481159))
;                   (seq.++ (seq.unit (- 2147473830))
;                           (seq.++ (seq.unit (- 2147473829))
;                                   (seq.unit (- 2147473828)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483559))
;                   (seq.++ (seq.unit (- 2147483449))
;                           (seq.++ (seq.unit (- 2147483428)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483634))
;                   (seq.++ (seq.unit (- 2147483624))
;                           (seq.++ (seq.unit (- 2147483614)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483638))
;                   (seq.++ (seq.unit (- 2147483636))
;                           (seq.++ (seq.unit (- 2147483635)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483641))
;                   (seq.++ (seq.unit (- 2147483640))
;                           (seq.++ (seq.unit (- 2147483639)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483644))
;                   (seq.++ (seq.unit (- 2147483643))
;                           (seq.++ (seq.unit (- 2147483642)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483647))
;                   (seq.++ (seq.unit (- 2147483646))
;                           (seq.++ (seq.unit (- 2147483645)) a!6)))))
