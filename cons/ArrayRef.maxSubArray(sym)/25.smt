...
(assert (= retMain_77_SYMINT ret_75_SYMINT))
...
;                  (not (= x!1 (- 10)))
;                  (not (= x!1 9)))))
;      (a!2 (seq.++ (seq.unit (- 2147483228))
;                   (seq.++ (seq.unit (- 2147482117))
;                           (seq.++ (seq.unit (- 2147482116))
;                                   (seq.unit (- 2147482115)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483624))
;                   (seq.++ (seq.unit (- 2147483555))
;                           (seq.++ (seq.unit (- 2147483491)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483632))
;                   (seq.++ (seq.unit (- 2147483630))
;                           (seq.++ (seq.unit (- 2147483629)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483636))
;                   (seq.++ (seq.unit (- 2147483634))
;                           (seq.++ (seq.unit (- 2147483633)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483639))
;                   (seq.++ (seq.unit (- 2147483638))
;                           (seq.++ (seq.unit (- 2147483637)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483642))
;                   (seq.++ (seq.unit (- 2147483641))
;                           (seq.++ (seq.unit (- 2147483640)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483645))
;                   (seq.++ (seq.unit (- 2147483644))
;                           (seq.++ (seq.unit (- 2147483643)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483648))
;                   (seq.++ (seq.unit (- 2147483647))
;                           (seq.++ (seq.unit (- 2147483646)) a!8)))))
;  (List_Int a!1 a!9))))))))))
