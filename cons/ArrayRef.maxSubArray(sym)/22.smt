...
;
(declare-const retMain_68_SYMINT Int)
(assert (= retMain_68_SYMINT ret_66_SYMINT))
...
;                  (not (= x!1 3))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147482533))
;                   (seq.++ (seq.unit (- 2147482414))
;                           (seq.++ (seq.unit (- 2147482413))
;                                   (seq.unit (- 2147482412)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483526))
;                   (seq.++ (seq.unit (- 2147483262))
;                           (seq.++ (seq.unit (- 2147483061)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483578))
;                   (seq.++ (seq.unit (- 2147483572))
;                           (seq.++ (seq.unit (- 2147483530)) a!3)))))
