...
;
(declare-const retMain_32_SYMINT Int)
(assert (= retMain_32_SYMINT ret_30_SYMINT))
;(define-fun length_13_SYMINT () Int
;  10)
;(define-fun length_2_SYMINT () Int
;  10)
;(define-fun nums_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147483585))
;                   (seq.++ (seq.unit (- 2147480828))
;                           (seq.++ (seq.unit (- 2147480827))
;                                   (seq.unit (- 2147480826)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483636))
;                   (seq.++ (seq.unit (- 2147483630))
;                           (seq.++ (seq.unit (- 2147483604)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483645))
;                   (seq.++ (seq.unit (- 2147483643))
;                           (seq.++ (seq.unit (- 2147483638)) a!2)))))
