...
;
(declare-const retMain_50_SYMINT Int)
(assert (= retMain_50_SYMINT ret_48_SYMINT))
...
;                  (not (= x!1 9))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147482762))
;                   (seq.++ (seq.unit (- 2147482398))
;                           (seq.++ (seq.unit (- 2147482397))
;                                   (seq.unit (- 2147482396)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483562))
;                   (seq.++ (seq.unit (- 2147483559))
;                           (seq.++ (seq.unit (- 2147483101)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483630))
