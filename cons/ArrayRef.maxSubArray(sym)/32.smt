...
;
(declare-const retMain_98_SYMINT Int)
(assert (= retMain_98_SYMINT ret_96_SYMINT))
...
;(let ((a!11 (seq.++ (seq.unit (- 2147483647))
;                    (seq.++ (seq.unit (- 2147483646))
;                            (seq.++ (seq.unit (- 2147483645)) a!10)))))
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483648)) a!11)))))))))))))
