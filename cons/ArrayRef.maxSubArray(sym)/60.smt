...
;
(declare-const retMain_182_SYMINT Int)
(assert (= retMain_182_SYMINT ret_180_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481575))
;                   (seq.++ (seq.unit (- 2147481124))
;                           (seq.++ (seq.unit (- 2147481123))
;                                   (seq.unit (- 2147481122)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483221))
;                   (seq.++ (seq.unit (- 2147483171))
;                           (seq.++ (seq.unit (- 2147482662)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483589))
;                   (seq.++ (seq.unit (- 2147483561))
;                           (seq.++ (seq.unit (- 2147483442)) a!2)))))
