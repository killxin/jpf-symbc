...
;
(declare-const retMain_155_SYMINT Int)
(assert (= retMain_155_SYMINT ret_153_SYMINT))
...
;                  (not (= x!1 3))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147481221))
;                   (seq.++ (seq.unit (- 2147476284))
;                           (seq.++ (seq.unit (- 2147476283))
;                                   (seq.unit (- 2147476282)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483469))
;                   (seq.++ (seq.unit (- 2147483243))
;                           (seq.++ (seq.unit (- 2147483177)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483603))
;                   (seq.++ (seq.unit (- 2147483595))
;                           (seq.++ (seq.unit (- 2147483475)) a!3)))))
