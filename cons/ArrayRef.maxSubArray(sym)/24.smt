...
;
(declare-const retMain_74_SYMINT Int)
(assert (= retMain_74_SYMINT ret_72_SYMINT))
...
;                  (not (= x!1 (- 3)))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147478994))
;                   (seq.++ (seq.unit (- 2147478341))
;                           (seq.++ (seq.unit (- 2147478340))
;                                   (seq.unit (- 2147478339)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483078))
;                   (seq.++ (seq.unit (- 2147481834))
;                           (seq.++ (seq.unit (- 2147480643)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483436))
;                   (seq.++ (seq.unit (- 2147483423))
;                           (seq.++ (seq.unit (- 2147483378)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483637))
...
;(let ((a!8 (seq.++ (seq.unit (- 2147483646))
;                   (seq.++ (seq.unit (- 2147483645))
;                           (seq.++ (seq.unit (- 2147483644)) a!7)))))
;  (List_Int a!1
;            (seq.++ (seq.unit (- 2147483648))
;                    (seq.++ (seq.unit (- 2147483647)) a!8)))))))))))
