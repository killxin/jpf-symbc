...
;
(declare-const retMain_173_SYMINT Int)
(assert (= retMain_173_SYMINT ret_171_SYMINT))
...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147482081))
;                   (seq.++ (seq.unit (- 2147481553))
;                           (seq.++ (seq.unit (- 2147481552))
;                                   (seq.unit (- 2147481551)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483571))
;                   (seq.++ (seq.unit (- 2147483522))
;                           (seq.++ (seq.unit (- 2147482673)) a!2)))))
