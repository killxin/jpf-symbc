...
;
(declare-const retMain_110_SYMINT Int)
(assert (= retMain_110_SYMINT ret_108_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147483186))
;                   (seq.++ (seq.unit (- 2147482909))
;                           (seq.++ (seq.unit (- 2147482908))
;                                   (seq.unit (- 2147482907)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483521))
;                   (seq.++ (seq.unit (- 2147483369))
;                           (seq.++ (seq.unit (- 2147483322)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483618))
;                   (seq.++ (seq.unit (- 2147483616))
;                           (seq.++ (seq.unit (- 2147483615)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483623))
;                   (seq.++ (seq.unit (- 2147483622))
;                           (seq.++ (seq.unit (- 2147483621)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483626))
;                   (seq.++ (seq.unit (- 2147483625))
;                           (seq.++ (seq.unit (- 2147483624)) a!4)))))
