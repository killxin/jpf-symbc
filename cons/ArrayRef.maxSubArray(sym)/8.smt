...
;
(declare-const retMain_26_SYMINT Int)
(assert (= retMain_26_SYMINT ret_24_SYMINT))
;(define-fun length_13_SYMINT () Int
;  8)
;(define-fun length_2_SYMINT () Int
;  8)
;(define-fun nums_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147475103))
;                   (seq.++ (seq.unit (- 2147475102))
;                           (seq.++ (seq.unit (- 2147475101))
;                                   (seq.unit (- 2147475100)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147475631))
;                   (seq.++ (seq.unit (- 2147475305))
;                           (seq.++ (seq.unit (- 2147475108)) a!1)))))
