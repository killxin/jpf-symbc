...
;
(declare-const retMain_158_SYMINT Int)
(assert (= retMain_158_SYMINT ret_156_SYMINT))
...
;(let ((a!18 (seq.++ (seq.unit (- 2147483647))
;                    (seq.++ (seq.unit (- 2147483646))
;                            (seq.++ (seq.unit (- 2147483645)) a!17)))))
;  (List_Int a!1 a!18)))))))))))))))))))
