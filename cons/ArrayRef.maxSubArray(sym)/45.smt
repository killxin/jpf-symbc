...
;
(declare-const retMain_137_SYMINT Int)
(assert (= retMain_137_SYMINT ret_135_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147482295))
;                   (seq.++ (seq.unit (- 2147477317))
;                           (seq.++ (seq.unit (- 2147477316))
;                                   (seq.unit (- 2147477315)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483564))
;                   (seq.++ (seq.unit (- 2147483365))
;                           (seq.++ (seq.unit (- 2147483026)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483600))
;                   (seq.++ (seq.unit (- 2147483597))
;                           (seq.++ (seq.unit (- 2147483580)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483616))
;                   (seq.++ (seq.unit (- 2147483613))
;                           (seq.++ (seq.unit (- 2147483604)) a!3)))))
