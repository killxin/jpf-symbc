...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147481580))
;                   (seq.++ (seq.unit (- 2147479367))
;                           (seq.++ (seq.unit (- 2147479366))
;                                   (seq.unit (- 2147479365)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483335))
;                   (seq.++ (seq.unit (- 2147483303))
;                           (seq.++ (seq.unit (- 2147482496)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483568))
;                   (seq.++ (seq.unit (- 2147483493))
;                           (seq.++ (seq.unit (- 2147483464)) a!3)))))
