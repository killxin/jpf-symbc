...
;
(declare-const retMain_88_SYMINT Int)
(assert (= retMain_88_SYMINT ret_86_SYMINT))
...
;                  (not (= x!1 (- 11)))
;                  (not (= x!1 (- 7))))))
;      (a!2 (seq.++ (seq.unit (- 2147481839))
;                   (seq.++ (seq.unit (- 2147481838))
;                           (seq.++ (seq.unit (- 2147481837))
;                                   (seq.unit 2147472002))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483615))
;                   (seq.++ (seq.unit (- 2147483495))
;                           (seq.++ (seq.unit (- 2147482994)) a!2)))))
