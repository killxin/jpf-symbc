...
;
(declare-const retMain_84_SYMINT Int)
(assert (= retMain_84_SYMINT ret_82_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481301))
;                   (seq.++ (seq.unit (- 2147481300))
;                           (seq.++ (seq.unit (- 2147481299))
;                                   (seq.unit (- 2147473062)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483578))
;                   (seq.++ (seq.unit (- 2147483563))
;                           (seq.++ (seq.unit (- 2147483352)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483627))
;                   (seq.++ (seq.unit (- 2147483618))
;                           (seq.++ (seq.unit (- 2147483597)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483637))
;                   (seq.++ (seq.unit (- 2147483635))
;                           (seq.++ (seq.unit (- 2147483631)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483643))
;                   (seq.++ (seq.unit (- 2147483642))
;                           (seq.++ (seq.unit (- 2147483641)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483646))
;                   (seq.++ (seq.unit (- 2147483645))
;                           (seq.++ (seq.unit (- 2147483644)) a!5)))))
