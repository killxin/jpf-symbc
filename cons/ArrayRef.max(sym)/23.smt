...
;
(declare-const retMain_92_SYMINT Int)
(assert (= retMain_92_SYMINT ret_90_SYMINT))
...
;                  (not (= x!1 (- 1)))
;                  (not (= x!1 (- 5))))))
;      (a!2 (seq.++ (seq.unit (- 2147476008))
;                   (seq.++ (seq.unit (- 2147476007))
;                           (seq.++ (seq.unit (- 2147476006))
;                                   (seq.unit (- 2147472874)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147478782))
;                   (seq.++ (seq.unit (- 2147476353))
;                           (seq.++ (seq.unit (- 2147476039)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483470))
;                   (seq.++ (seq.unit (- 2147482210))
;                           (seq.++ (seq.unit (- 2147481694)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483632))
;                   (seq.++ (seq.unit (- 2147483532))
;                           (seq.++ (seq.unit (- 2147483472)) a!4)))))
...
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483642)) a!8))))))))))
