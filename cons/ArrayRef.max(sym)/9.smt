...
;
(declare-const retMain_36_SYMINT Int)
(assert (= retMain_36_SYMINT ret_34_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481806))
;                   (seq.++ (seq.unit (- 2147481802))
;                           (seq.++ (seq.unit (- 2147481801))
;                                   (seq.unit (- 2147481800)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482324))
;                   (seq.++ (seq.unit (- 2147482135))
;                           (seq.++ (seq.unit (- 2147481811)) a!1)))))
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 (- 8)) (= x!1 (- 9)) (= x!1 10)))
;            (seq.++ (seq.unit (- 2147483643))
;                    (seq.++ (seq.unit (- 2147483212)) a!2))))))
