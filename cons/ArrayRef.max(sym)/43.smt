...
;
(declare-const retMain_172_SYMINT Int)
(assert (= retMain_172_SYMINT ret_170_SYMINT))
...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147476600))
;                   (seq.++ (seq.unit (- 2147474525))
;                           (seq.++ (seq.unit (- 2147474524))
;                                   (seq.unit (- 2147474523)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483308))
;                   (seq.++ (seq.unit (- 2147483222))
;                           (seq.++ (seq.unit (- 2147481242)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483570))
;                   (seq.++ (seq.unit (- 2147483568))
;                           (seq.++ (seq.unit (- 2147483396)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483615))
;                   (seq.++ (seq.unit (- 2147483612))
;                           (seq.++ (seq.unit (- 2147483606)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483618))
;                   (seq.++ (seq.unit (- 2147483617))
;                           (seq.++ (seq.unit (- 2147483616)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483621))
;                   (seq.++ (seq.unit (- 2147483620))
;                           (seq.++ (seq.unit (- 2147483619)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483624))
;                   (seq.++ (seq.unit (- 2147483623))
;                           (seq.++ (seq.unit (- 2147483622)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483627))
;                   (seq.++ (seq.unit (- 2147483626))
;                           (seq.++ (seq.unit (- 2147483625)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147483630))
;                    (seq.++ (seq.unit (- 2147483629))
;                            (seq.++ (seq.unit (- 2147483628)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147483633))
;                    (seq.++ (seq.unit (- 2147483632))
;                            (seq.++ (seq.unit (- 2147483631)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147483636))
;                    (seq.++ (seq.unit (- 2147483635))
;                            (seq.++ (seq.unit (- 2147483634)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147483639))
;                    (seq.++ (seq.unit (- 2147483638))
;                            (seq.++ (seq.unit (- 2147483637)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147483642))
;                    (seq.++ (seq.unit (- 2147483641))
;                            (seq.++ (seq.unit (- 2147483640)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147483645))
;                    (seq.++ (seq.unit (- 2147483644))
;                            (seq.++ (seq.unit (- 2147483643)) a!14)))))
;  (List_Int a!1 a!15))))))))))))))))
