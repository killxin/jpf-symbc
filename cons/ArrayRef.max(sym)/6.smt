...
;
(declare-const retMain_24_SYMINT Int)
(assert (= retMain_24_SYMINT ret_22_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481411))
;                   (seq.++ (seq.unit (- 2147481410))
;                           (seq.++ (seq.unit (- 2147481409))
;                                   (seq.unit 2147475486))))))
