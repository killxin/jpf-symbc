...
;
(declare-const retMain_180_SYMINT Int)
(assert (= retMain_180_SYMINT ret_178_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147477589))
;                   (seq.++ (seq.unit (- 2147474865))
;                           (seq.++ (seq.unit (- 2147474864))
;                                   (seq.unit (- 2147474863)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483238))
;                   (seq.++ (seq.unit (- 2147482866))
;                           (seq.++ (seq.unit (- 2147482523)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483570))
;                   (seq.++ (seq.unit (- 2147483528))
;                           (seq.++ (seq.unit (- 2147483423)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483609))
