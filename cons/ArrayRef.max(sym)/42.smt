...
;
(declare-const retMain_168_SYMINT Int)
(assert (= retMain_168_SYMINT ret_166_SYMINT))
...
;                  (not (= x!1 1))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147478961))
;                   (seq.++ (seq.unit (- 2147478960))
;                           (seq.++ (seq.unit (- 2147478959))
;                                   (seq.unit 2147479196))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483357))
;                   (seq.++ (seq.unit (- 2147483174))
;                           (seq.++ (seq.unit (- 2147482756)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483612))
;                   (seq.++ (seq.unit (- 2147483557))
;                           (seq.++ (seq.unit (- 2147483444)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483618))
;                   (seq.++ (seq.unit (- 2147483616))
;                           (seq.++ (seq.unit (- 2147483614)) a!4)))))
