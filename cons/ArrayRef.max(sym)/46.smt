...
;
(declare-const retMain_184_SYMINT Int)
(assert (= retMain_184_SYMINT ret_182_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147481592))
;                   (seq.++ (seq.unit (- 2147481591))
;                           (seq.++ (seq.unit (- 2147481590))
;                                   (seq.unit (- 2147473181)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483159))
;                   (seq.++ (seq.unit (- 2147483138))
;                           (seq.++ (seq.unit (- 2147483109)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483521))
;                   (seq.++ (seq.unit (- 2147483477))
;                           (seq.++ (seq.unit (- 2147483444)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483607))
;                   (seq.++ (seq.unit (- 2147483603))
;                           (seq.++ (seq.unit (- 2147483553)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483618))
;                   (seq.++ (seq.unit (- 2147483617))
;                           (seq.++ (seq.unit (- 2147483616)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483621))
;                   (seq.++ (seq.unit (- 2147483620))
;                           (seq.++ (seq.unit (- 2147483619)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483624))
;                   (seq.++ (seq.unit (- 2147483623))
;                           (seq.++ (seq.unit (- 2147483622)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483627))
;                   (seq.++ (seq.unit (- 2147483626))
;                           (seq.++ (seq.unit (- 2147483625)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483630))
;                   (seq.++ (seq.unit (- 2147483629))
;                           (seq.++ (seq.unit (- 2147483628)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147483633))
;                    (seq.++ (seq.unit (- 2147483632))
;                            (seq.++ (seq.unit (- 2147483631)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147483636))
;                    (seq.++ (seq.unit (- 2147483635))
;                            (seq.++ (seq.unit (- 2147483634)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147483639))
;                    (seq.++ (seq.unit (- 2147483638))
;                            (seq.++ (seq.unit (- 2147483637)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147483642))
;                    (seq.++ (seq.unit (- 2147483641))
;                            (seq.++ (seq.unit (- 2147483640)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147483645))
;                    (seq.++ (seq.unit (- 2147483644))
;                            (seq.++ (seq.unit (- 2147483643)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147483648))
;                    (seq.++ (seq.unit (- 2147483647))
;                            (seq.++ (seq.unit (- 2147483646)) a!14)))))
