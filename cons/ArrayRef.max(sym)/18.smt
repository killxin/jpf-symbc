...
;
(declare-const retMain_72_SYMINT Int)
(assert (= retMain_72_SYMINT ret_70_SYMINT))
...
;                  (not (= x!1 (- 7)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147481322))
;                   (seq.++ (seq.unit (- 2147481321))
;                           (seq.++ (seq.unit (- 2147481320))
;                                   (seq.unit (- 2147473718)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483184))
;                   (seq.++ (seq.unit (- 2147483101))
;                           (seq.++ (seq.unit (- 2147483044)) a!2)))))
