...
;
(declare-const retMain_112_SYMINT Int)
(assert (= retMain_112_SYMINT ret_110_SYMINT))
...
;                  (not (= x!1 3))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147482239))
;                   (seq.++ (seq.unit (- 2147482238))
;                           (seq.++ (seq.unit (- 2147482237))
;                                   (seq.unit (- 2147478836)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483615))
;                   (seq.++ (seq.unit (- 2147483477))
;                           (seq.++ (seq.unit (- 2147482961)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483629))
;                   (seq.++ (seq.unit (- 2147483626))
;                           (seq.++ (seq.unit (- 2147483618)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483632))
;                   (seq.++ (seq.unit (- 2147483631))
;                           (seq.++ (seq.unit (- 2147483630)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483635))
;                   (seq.++ (seq.unit (- 2147483634))
;                           (seq.++ (seq.unit (- 2147483633)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483638))
;                   (seq.++ (seq.unit (- 2147483637))
;                           (seq.++ (seq.unit (- 2147483636)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483641))
;                   (seq.++ (seq.unit (- 2147483640))
;                           (seq.++ (seq.unit (- 2147483639)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483644))
;                   (seq.++ (seq.unit (- 2147483643))
;                           (seq.++ (seq.unit (- 2147483642)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147483647))
;                    (seq.++ (seq.unit (- 2147483646))
;                            (seq.++ (seq.unit (- 2147483645)) a!9)))))
;  (List_Int a!1 a!10)))))))))))
