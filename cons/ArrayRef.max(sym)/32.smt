...
;
(declare-const retMain_128_SYMINT Int)
(assert (= retMain_128_SYMINT ret_126_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147475171))
;                   (seq.++ (seq.unit (- 2147473806))
;                           (seq.++ (seq.unit (- 2147473805))
;                                   (seq.unit (- 2147473804)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483549))
;                   (seq.++ (seq.unit (- 2147483288))
;                           (seq.++ (seq.unit (- 2147481756)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483623))
;                   (seq.++ (seq.unit (- 2147483621))
;                           (seq.++ (seq.unit (- 2147483588)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483628))
;                   (seq.++ (seq.unit (- 2147483626))
;                           (seq.++ (seq.unit (- 2147483624)) a!3)))))
