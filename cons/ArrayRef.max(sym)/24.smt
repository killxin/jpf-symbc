...
;
(declare-const retMain_96_SYMINT Int)
(assert (= retMain_96_SYMINT ret_94_SYMINT))
...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147474415))
;                   (seq.++ (seq.unit (- 2147474414))
;                           (seq.++ (seq.unit (- 2147474413))
;                                   (seq.unit 2147481970))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147480152))
;                   (seq.++ (seq.unit (- 2147476983))
;                           (seq.++ (seq.unit (- 2147476165)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147482330))
;                   (seq.++ (seq.unit (- 2147481711))
;                           (seq.++ (seq.unit (- 2147481482)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483635))
;                   (seq.++ (seq.unit (- 2147483632))
;                           (seq.++ (seq.unit (- 2147483603)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483638))
;                   (seq.++ (seq.unit (- 2147483637))
;                           (seq.++ (seq.unit (- 2147483636)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483641))
;                   (seq.++ (seq.unit (- 2147483640))
;                           (seq.++ (seq.unit (- 2147483639)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483644))
;                   (seq.++ (seq.unit (- 2147483643))
;                           (seq.++ (seq.unit (- 2147483642)) a!7)))))
;  (List_Int a!1
;            (seq.++ (seq.unit (- 2147483646))
;                    (seq.++ (seq.unit (- 2147483645)) a!8)))))))))))
