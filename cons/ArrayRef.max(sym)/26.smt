...
;
(declare-const retMain_104_SYMINT Int)
(assert (= retMain_104_SYMINT ret_102_SYMINT))
...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147481808))
;                   (seq.++ (seq.unit (- 2147481559))
;                           (seq.++ (seq.unit (- 2147481558))
;                                   (seq.unit (- 2147481557)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483533))
;                   (seq.++ (seq.unit (- 2147483488))
;                           (seq.++ (seq.unit (- 2147483444)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483591))
;                   (seq.++ (seq.unit (- 2147483576))
;                           (seq.++ (seq.unit (- 2147483572)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483630))
...
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483643)) a!9)))))))))))
