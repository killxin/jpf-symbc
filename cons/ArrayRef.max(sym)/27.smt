...
;
(declare-const retMain_108_SYMINT Int)
(assert (= retMain_108_SYMINT ret_106_SYMINT))
...
;                  (not (= x!1 (- 11)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147474567))
;                   (seq.++ (seq.unit (- 2147474566))
;                           (seq.++ (seq.unit (- 2147474565))
;                                   (seq.unit (- 2147468488)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483178))
;                   (seq.++ (seq.unit (- 2147482767))
;                           (seq.++ (seq.unit (- 2147482265)) a!2)))))
