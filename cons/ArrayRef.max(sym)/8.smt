...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478859))
;                   (seq.++ (seq.unit (- 2147478316))
;                           (seq.++ (seq.unit (- 2147478315))
;                                   (seq.unit (- 2147478314)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482916))
;                   (seq.++ (seq.unit (- 2147482646))
;                           (seq.++ (seq.unit (- 2147482462)) a!1)))))
