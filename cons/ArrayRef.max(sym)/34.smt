...
;
(declare-const retMain_136_SYMINT Int)
(assert (= retMain_136_SYMINT ret_134_SYMINT))
...
;                  (not (= x!1 (- 1)))
;                  (not (= x!1 (- 7))))))
;      (a!2 (seq.++ (seq.unit (- 2147483242))
;                   (seq.++ (seq.unit (- 2147483241))
;                           (seq.++ (seq.unit (- 2147483240))
;                                   (seq.unit (- 2147481614)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483611))
;                   (seq.++ (seq.unit (- 2147483604))
;                           (seq.++ (seq.unit (- 2147483308)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483620))
;                   (seq.++ (seq.unit (- 2147483619))
;                           (seq.++ (seq.unit (- 2147483616)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483624))
;                   (seq.++ (seq.unit (- 2147483623))
;                           (seq.++ (seq.unit (- 2147483622)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483629))
;                   (seq.++ (seq.unit (- 2147483628))
;                           (seq.++ (seq.unit (- 2147483627)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483632))
;                   (seq.++ (seq.unit (- 2147483631))
;                           (seq.++ (seq.unit (- 2147483630)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483635))
;                   (seq.++ (seq.unit (- 2147483634))
;                           (seq.++ (seq.unit (- 2147483633)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483638))
;                   (seq.++ (seq.unit (- 2147483637))
;                           (seq.++ (seq.unit (- 2147483636)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147483641))
;                    (seq.++ (seq.unit (- 2147483640))
;                            (seq.++ (seq.unit (- 2147483639)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147483644))
;                    (seq.++ (seq.unit (- 2147483643))
;                            (seq.++ (seq.unit (- 2147483642)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147483647))
;                    (seq.++ (seq.unit (- 2147483646))
;                            (seq.++ (seq.unit (- 2147483645)) a!11)))))
;  (List_Int a!1 a!12)))))))))))))
