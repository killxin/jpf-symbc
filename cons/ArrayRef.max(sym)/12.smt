...
;
(declare-const retMain_48_SYMINT Int)
(assert (= retMain_48_SYMINT ret_46_SYMINT))
...
;                  (not (= x!1 (- 7)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147479942))
;                   (seq.++ (seq.unit (- 2147476682))
;                           (seq.++ (seq.unit (- 2147476681))
;                                   (seq.unit (- 2147476680)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483405))
;                   (seq.++ (seq.unit (- 2147483271))
;                           (seq.++ (seq.unit (- 2147483079)) a!2)))))
