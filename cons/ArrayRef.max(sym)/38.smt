...
;
(declare-const retMain_152_SYMINT Int)
(assert (= retMain_152_SYMINT ret_150_SYMINT))
...
;                  (not (= x!1 1))
;                  (not (= x!1 (- 11))))))
;      (a!2 (seq.++ (seq.unit (- 2147478284))
;                   (seq.++ (seq.unit (- 2147478283))
;                           (seq.++ (seq.unit (- 2147478282))
;                                   (seq.unit 2147483121))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483166))
;                   (seq.++ (seq.unit (- 2147482219))
;                           (seq.++ (seq.unit (- 2147480803)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483606))
;                   (seq.++ (seq.unit (- 2147483583))
;                           (seq.++ (seq.unit (- 2147483339)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483618))
;                   (seq.++ (seq.unit (- 2147483613))
;                           (seq.++ (seq.unit (- 2147483612)) a!4)))))
...
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483648)) a!13)))))))))))))))
