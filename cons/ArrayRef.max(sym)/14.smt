...
;  (let ((a!1 (seq.++ (seq.unit (- 2147479562))
;                   (seq.++ (seq.unit (- 2147479561))
;                           (seq.++ (seq.unit (- 2147479560))
;                                   (seq.unit (- 2147476327)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147482832))
;                   (seq.++ (seq.unit (- 2147482001))
;                           (seq.++ (seq.unit (- 2147481249)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483604))
;                   (seq.++ (seq.unit (- 2147483490))
;                           (seq.++ (seq.unit (- 2147483404)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483638))
;                   (seq.++ (seq.unit (- 2147483635))
;                           (seq.++ (seq.unit (- 2147483619)) a!3)))))
