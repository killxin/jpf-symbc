...
;
(declare-const retMain_40_SYMINT Int)
(assert (= retMain_40_SYMINT ret_38_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147474467))
;                   (seq.++ (seq.unit (- 2147474466))
;                           (seq.++ (seq.unit (- 2147474465))
;                                   (seq.unit 2147481910))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481567))
;                   (seq.++ (seq.unit (- 2147479107))
;                           (seq.++ (seq.unit (- 2147477900)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483093))
;                   (seq.++ (seq.unit (- 2147482957))
;                           (seq.++ (seq.unit (- 2147482374)) a!2)))))
