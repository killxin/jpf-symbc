...
;
(declare-const retMain_80_SYMINT Int)
(assert (= retMain_80_SYMINT ret_78_SYMINT))
...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147480041))
;                   (seq.++ (seq.unit (- 2147480040))
;                           (seq.++ (seq.unit (- 2147480039))
;                                   (seq.unit 2147481631))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483401))
;                   (seq.++ (seq.unit (- 2147483351))
;                           (seq.++ (seq.unit (- 2147482944)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483602))
;                   (seq.++ (seq.unit (- 2147483517))
;                           (seq.++ (seq.unit (- 2147483516)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483635))
;                   (seq.++ (seq.unit (- 2147483629))
;                           (seq.++ (seq.unit (- 2147483614)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483640))
;                   (seq.++ (seq.unit (- 2147483639))
;                           (seq.++ (seq.unit (- 2147483638)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483643))
;                   (seq.++ (seq.unit (- 2147483642))
;                           (seq.++ (seq.unit (- 2147483641)) a!6)))))
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483644)) a!7)))))))))
