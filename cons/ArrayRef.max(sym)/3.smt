...
;
(declare-const retMain_12_SYMINT Int)
(assert (= retMain_12_SYMINT ret_10_SYMINT))
...
;  (List_Int (lambda ((x!1 Int)) (or (= x!1 (- 9)) (= x!1 (- 10)) (= x!1 10)))
;          (seq.++ (seq.unit (- 2147482413))
;                  (seq.++ (seq.unit (- 2147482412)) (seq.unit (- 2147482411))))))
