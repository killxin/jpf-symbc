...
;
(declare-const retMain_124_SYMINT Int)
(assert (= retMain_124_SYMINT ret_122_SYMINT))
...
;                  (not (= x!1 1))
;                  (not (= x!1 (- 1))))))
;      (a!2 (seq.++ (seq.unit (- 2147482695))
;                   (seq.++ (seq.unit (- 2147482694))
;                           (seq.++ (seq.unit (- 2147482693))
;                                   (seq.unit 2147478147))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483547))
;                   (seq.++ (seq.unit (- 2147483090))
;                           (seq.++ (seq.unit (- 2147482752)) a!2)))))
...
;                           (seq.++ (seq.unit (- 2147483627)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483633))
;                   (seq.++ (seq.unit (- 2147483632))
;                           (seq.++ (seq.unit (- 2147483631)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483636))
;                   (seq.++ (seq.unit (- 2147483635))
;                           (seq.++ (seq.unit (- 2147483634)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483639))
;                   (seq.++ (seq.unit (- 2147483638))
;                           (seq.++ (seq.unit (- 2147483637)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483642))
;                   (seq.++ (seq.unit (- 2147483641))
;                           (seq.++ (seq.unit (- 2147483640)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147483645))
;                    (seq.++ (seq.unit (- 2147483644))
;                            (seq.++ (seq.unit (- 2147483643)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147483648))
;                    (seq.++ (seq.unit (- 2147483647))
;                            (seq.++ (seq.unit (- 2147483646)) a!10)))))
;  (List_Int a!1 a!11))))))))))))
