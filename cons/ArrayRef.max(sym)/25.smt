...
;
(declare-const retMain_100_SYMINT Int)
(assert (= retMain_100_SYMINT ret_98_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147479188))
;                   (seq.++ (seq.unit (- 2147476874))
;                           (seq.++ (seq.unit (- 2147476873))
;                                   (seq.unit (- 2147476872)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483459))
;                   (seq.++ (seq.unit (- 2147483353))
;                           (seq.++ (seq.unit (- 2147483148)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483612))
;                   (seq.++ (seq.unit (- 2147483589))
;                           (seq.++ (seq.unit (- 2147483526)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483636))
;                   (seq.++ (seq.unit (- 2147483634))
;                           (seq.++ (seq.unit (- 2147483633)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483639))
;                   (seq.++ (seq.unit (- 2147483638))
;                           (seq.++ (seq.unit (- 2147483637)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483642))
;                   (seq.++ (seq.unit (- 2147483641))
;                           (seq.++ (seq.unit (- 2147483640)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483645))
;                   (seq.++ (seq.unit (- 2147483644))
;                           (seq.++ (seq.unit (- 2147483643)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483648))
;                   (seq.++ (seq.unit (- 2147483647))
;                           (seq.++ (seq.unit (- 2147483646)) a!7)))))
