...
;
(declare-const retMain_132_SYMINT Int)
(assert (= retMain_132_SYMINT ret_130_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147476782))
;                   (seq.++ (seq.unit (- 2147476781))
;                           (seq.++ (seq.unit (- 2147476780))
;                                   (seq.unit 2147474614))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483608))
;                   (seq.++ (seq.unit (- 2147483572))
;                           (seq.++ (seq.unit (- 2147482748)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483624))
;                   (seq.++ (seq.unit (- 2147483620))
;                           (seq.++ (seq.unit (- 2147483612)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483627))
;                   (seq.++ (seq.unit (- 2147483626))
;                           (seq.++ (seq.unit (- 2147483625)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483631))
;                   (seq.++ (seq.unit (- 2147483630))
;                           (seq.++ (seq.unit (- 2147483629)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483634))
;                   (seq.++ (seq.unit (- 2147483633))
;                           (seq.++ (seq.unit (- 2147483632)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483637))
;                   (seq.++ (seq.unit (- 2147483636))
;                           (seq.++ (seq.unit (- 2147483635)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483640))
;                   (seq.++ (seq.unit (- 2147483639))
;                           (seq.++ (seq.unit (- 2147483638)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483643))
;                   (seq.++ (seq.unit (- 2147483642))
;                           (seq.++ (seq.unit (- 2147483641)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147483646))
;                    (seq.++ (seq.unit (- 2147483645))
;                            (seq.++ (seq.unit (- 2147483644)) a!9)))))
