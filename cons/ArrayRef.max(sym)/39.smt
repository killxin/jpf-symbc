...
;
(declare-const retMain_156_SYMINT Int)
(assert (= retMain_156_SYMINT ret_154_SYMINT))
...
;                  (not (= x!1 3))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147482430))
;                   (seq.++ (seq.unit (- 2147478128))
;                           (seq.++ (seq.unit (- 2147478127))
;                                   (seq.unit (- 2147478126)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483279))
;                   (seq.++ (seq.unit (- 2147483072))
;                           (seq.++ (seq.unit (- 2147482687)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483543))
;                   (seq.++ (seq.unit (- 2147483524))
;                           (seq.++ (seq.unit (- 2147483455)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483596))
;                   (seq.++ (seq.unit (- 2147483586))
;                           (seq.++ (seq.unit (- 2147483544)) a!4)))))
