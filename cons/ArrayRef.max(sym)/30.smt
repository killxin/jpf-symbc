...
;
(declare-const retMain_120_SYMINT Int)
(assert (= retMain_120_SYMINT ret_118_SYMINT))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478282))
;                   (seq.++ (seq.unit (- 2147478281))
;                           (seq.++ (seq.unit (- 2147478280))
;                                   (seq.unit (- 2147468821)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483565))
;                   (seq.++ (seq.unit (- 2147483337))
;                           (seq.++ (seq.unit (- 2147482281)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483623))
;                   (seq.++ (seq.unit (- 2147483589))
;                           (seq.++ (seq.unit (- 2147483582)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483629))
;                   (seq.++ (seq.unit (- 2147483627))
;                           (seq.++ (seq.unit (- 2147483625)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147483634))
;                   (seq.++ (seq.unit (- 2147483633))
;                           (seq.++ (seq.unit (- 2147483632)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483637))
;                   (seq.++ (seq.unit (- 2147483636))
;                           (seq.++ (seq.unit (- 2147483635)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483640))
;                   (seq.++ (seq.unit (- 2147483639))
;                           (seq.++ (seq.unit (- 2147483638)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147483643))
;                   (seq.++ (seq.unit (- 2147483642))
;                           (seq.++ (seq.unit (- 2147483641)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147483646))
;                   (seq.++ (seq.unit (- 2147483645))
;                           (seq.++ (seq.unit (- 2147483644)) a!8)))))
