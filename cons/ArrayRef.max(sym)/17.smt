...
;                  (not (= x!1 (- 1)))
;                  (not (= x!1 (- 7))))))
;      (a!2 (seq.++ (seq.unit (- 2147476512))
;                   (seq.++ (seq.unit (- 2147476511))
;                           (seq.++ (seq.unit (- 2147476510))
;                                   (seq.unit (- 2147475466)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483287))
;                   (seq.++ (seq.unit (- 2147480416))
;                           (seq.++ (seq.unit (- 2147478863)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483583))
;                   (seq.++ (seq.unit (- 2147483553))
;                           (seq.++ (seq.unit (- 2147483499)) a!3)))))
...
;  (List_Int a!1 (seq.++ (seq.unit (- 2147483647)) a!6))))))))
