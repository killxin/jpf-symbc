...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478243))
;                   (seq.++ (seq.unit (- 2147473850))
;                           (seq.++ (seq.unit (- 2147480121))
;                                   (seq.unit (- 2147473726)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147475350))
;                   (seq.++ (seq.unit (- 2147482630))
;                           (seq.++ (seq.unit (- 2147473955)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481297))
;                   (seq.++ (seq.unit (- 2147482060))
;                           (seq.++ (seq.unit (- 2147481586)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481714))
;                   (seq.++ (seq.unit (- 2147482651))
;                           (seq.++ (seq.unit (- 2147479334)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147477820))
;                   (seq.++ (seq.unit (- 2147475206))
;                           (seq.++ (seq.unit (- 2147481677)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147480373))
;                   (seq.++ (seq.unit (- 2147479940))
;                           (seq.++ (seq.unit (- 2147478310)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147483511))
;                   (seq.++ (seq.unit (- 2147476422))
;                           (seq.++ (seq.unit (- 2147482631)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147478964))
;                   (seq.++ (seq.unit (- 2147480331))
;                           (seq.++ (seq.unit (- 2147475111)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147478111))
;                   (seq.++ (seq.unit (- 2147474512))
;                           (seq.++ (seq.unit (- 2147476917)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147478786))
;                    (seq.++ (seq.unit (- 2147481113))
;                            (seq.++ (seq.unit (- 2147477830)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147481068))
;                    (seq.++ (seq.unit (- 2147482693))
;                            (seq.++ (seq.unit (- 2147480176)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147473798))
;                    (seq.++ (seq.unit (- 2147481763))
;                            (seq.++ (seq.unit (- 2147482549)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147476045))
;                    (seq.++ (seq.unit (- 2147482850))
;                            (seq.++ (seq.unit (- 2147477968)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147480209))
;                    (seq.++ (seq.unit (- 2147479996))
;                            (seq.++ (seq.unit (- 2147480980)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147482239))
;                    (seq.++ (seq.unit (- 2147479836))
;                            (seq.++ (seq.unit (- 2147481846)) a!14)))))
;(let ((a!16 (seq.++ (seq.unit (- 2147474955))
;                    (seq.++ (seq.unit (- 2147475802))
;                            (seq.++ (seq.unit (- 2147474535)) a!15)))))
;(let ((a!17 (seq.++ (seq.unit (- 2147479684))
;                    (seq.++ (seq.unit (- 2147476790))
;                            (seq.++ (seq.unit (- 2147478681)) a!16)))))
;(let ((a!18 (seq.++ (seq.unit (- 2147474023))
;                    (seq.++ (seq.unit (- 2147478098))
;                            (seq.++ (seq.unit (- 2147477296)) a!17)))))
