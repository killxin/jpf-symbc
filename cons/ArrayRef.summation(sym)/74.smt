...
;  (let ((a!1 (seq.++ (seq.unit (- 2147483256))
;                   (seq.++ (seq.unit (- 2147476191))
;                           (seq.++ (seq.unit (- 2147479779))
;                                   (seq.unit (- 2147475839)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147474275))
;                   (seq.++ (seq.unit (- 2147474419))
;                           (seq.++ (seq.unit (- 2147481057)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477115))
;                   (seq.++ (seq.unit (- 2147480478))
;                           (seq.++ (seq.unit (- 2147476706)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483180))
;                   (seq.++ (seq.unit (- 2147474376))
;                           (seq.++ (seq.unit (- 2147481186)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147474120))
;                   (seq.++ (seq.unit (- 2147480530))
;                           (seq.++ (seq.unit (- 2147482151)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147474367))
;                   (seq.++ (seq.unit (- 2147475075))
;                           (seq.++ (seq.unit (- 2147480814)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147478150))
;                   (seq.++ (seq.unit (- 2147482718))
;                           (seq.++ (seq.unit (- 2147483033)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147481799))
;                   (seq.++ (seq.unit (- 2147482202))
;                           (seq.++ (seq.unit (- 2147476993)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147482064))
;                   (seq.++ (seq.unit (- 2147480367))
;                           (seq.++ (seq.unit (- 2147479880)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147473841))
;                    (seq.++ (seq.unit (- 2147478836))
;                            (seq.++ (seq.unit (- 2147483314)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147475895))
;                    (seq.++ (seq.unit (- 2147476725))
;                            (seq.++ (seq.unit (- 2147480848)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147474263))
;                    (seq.++ (seq.unit (- 2147475813))
;                            (seq.++ (seq.unit (- 2147479537)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147481702))
;                    (seq.++ (seq.unit (- 2147481360))
;                            (seq.++ (seq.unit (- 2147481922)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147482193))
;                    (seq.++ (seq.unit (- 2147481382))
;                            (seq.++ (seq.unit (- 2147481045)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147480857))
;                    (seq.++ (seq.unit (- 2147483569))
;                            (seq.++ (seq.unit (- 2147481231)) a!14)))))
;(let ((a!16 (seq.++ (seq.unit (- 2147478692))
;                    (seq.++ (seq.unit (- 2147477107))
;                            (seq.++ (seq.unit (- 2147474902)) a!15)))))
;(let ((a!17 (seq.++ (seq.unit (- 2147475321))
;                    (seq.++ (seq.unit (- 2147481518))
;                            (seq.++ (seq.unit (- 2147481639)) a!16)))))
;(let ((a!18 (seq.++ (seq.unit (- 2147482988))
;                    (seq.++ (seq.unit (- 2147483272))
;                            (seq.++ (seq.unit (- 2147475410)) a!17)))))
;(let ((a!19 (seq.++ (seq.unit (- 2147478267))
;                    (seq.++ (seq.unit (- 2147482199))
;                            (seq.++ (seq.unit (- 2147481342)) a!18)))))
;(let ((a!20 (seq.++ (seq.unit (- 2147482249))
;                    (seq.++ (seq.unit (- 2147482524))
;                            (seq.++ (seq.unit (- 2147475798)) a!19)))))
;(let ((a!21 (seq.++ (seq.unit (- 2147480970))
;                    (seq.++ (seq.unit (- 2147476832))
;                            (seq.++ (seq.unit (- 2147478285)) a!20)))))
;(let ((a!22 (seq.++ (seq.unit (- 2147482486))
;                    (seq.++ (seq.unit (- 2147482413))
;                            (seq.++ (seq.unit (- 2147475291)) a!21)))))
;(let ((a!23 (seq.++ (seq.unit (- 2147478462))
;                    (seq.++ (seq.unit (- 2147482400))
;                            (seq.++ (seq.unit (- 2147483323)) a!22)))))
;(let ((a!24 (seq.++ (seq.unit (- 2147481401))
;                    (seq.++ (seq.unit (- 2147474476))
;                            (seq.++ (seq.unit (- 2147480256)) a!23)))))
