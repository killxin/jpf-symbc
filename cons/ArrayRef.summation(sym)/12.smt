...
;
(declare-const retMain_25_SYMINT Int)
(assert (= retMain_25_SYMINT ( +  ret_24_SYMINT ( +  ret_22_SYMINT ( +  ret_20_SYMINT ( +  ret_18_SYMINT ( +  ret_16_SYMINT ( +  ret_14_SYMINT ( +  ret_12_SYMINT ( +  ret_10_SYMINT ( +  ret_8_SYMINT ( +  ret_6_SYMINT ret_4_SYMINT))))))))))))
...
;                  (not (= x!1 9))
;                  (not (= x!1 5)))))
;      (a!2 (seq.++ (seq.unit (- 2147478569))
;                   (seq.++ (seq.unit (- 2147474601))
;                           (seq.++ (seq.unit (- 2147482586))
;                                   (seq.unit (- 2147482155)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147483536))
;                   (seq.++ (seq.unit (- 2147478321))
;                           (seq.++ (seq.unit (- 2147482902)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147480906))
;                   (seq.++ (seq.unit (- 2147476890))
;                           (seq.++ (seq.unit (- 2147482465)) a!3)))))
;  (List_Int a!1 (seq.++ (seq.unit (- 2147476758)) a!4))))))
