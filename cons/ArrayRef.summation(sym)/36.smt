...
;  (let ((a!1 (seq.++ (seq.unit (- 2147482175))
;                   (seq.++ (seq.unit (- 2147474195))
;                           (seq.++ (seq.unit (- 2147474817))
;                                   (seq.unit (- 2147473920)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147475408))
;                   (seq.++ (seq.unit (- 2147479693))
;                           (seq.++ (seq.unit (- 2147475869)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481568))
;                   (seq.++ (seq.unit (- 2147482015))
;                           (seq.++ (seq.unit (- 2147478663)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147474350))
;                   (seq.++ (seq.unit (- 2147475303))
;                           (seq.++ (seq.unit (- 2147481912)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147482177))
;                   (seq.++ (seq.unit (- 2147477166))
;                           (seq.++ (seq.unit (- 2147480559)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147482023))
;                   (seq.++ (seq.unit (- 2147481620))
;                           (seq.++ (seq.unit (- 2147474444)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147478258))
;                   (seq.++ (seq.unit (- 2147483272))
;                           (seq.++ (seq.unit (- 2147482810)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147475264))
;                   (seq.++ (seq.unit (- 2147482300))
;                           (seq.++ (seq.unit (- 2147473698)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147475327))
;                   (seq.++ (seq.unit (- 2147478200))
;                           (seq.++ (seq.unit (- 2147478600)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147481495))
;                    (seq.++ (seq.unit (- 2147482633))
;                            (seq.++ (seq.unit (- 2147483199)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147480804))
;                    (seq.++ (seq.unit (- 2147483100))
;                            (seq.++ (seq.unit (- 2147478107)) a!10)))))
