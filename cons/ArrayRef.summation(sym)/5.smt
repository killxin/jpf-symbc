...
;
(declare-const retMain_11_SYMINT Int)
(assert (= retMain_11_SYMINT ( +  ret_10_SYMINT ( +  ret_8_SYMINT ( +  ret_6_SYMINT ret_4_SYMINT)))))
;(define-fun ret_4_SYMINT () Int
;  (- 2147475762))
;(define-fun numbers_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147475762))
;                   (seq.++ (seq.unit (- 2147475427))
