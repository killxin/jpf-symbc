...
;
(declare-const retMain_37_SYMINT Int)
(assert (= retMain_37_SYMINT ( +  ret_36_SYMINT ( +  ret_34_SYMINT ( +  ret_32_SYMINT ( +  ret_30_SYMINT ( +  ret_28_SYMINT ( +  ret_26_SYMINT ( +  ret_24_SYMINT ( +  ret_22_SYMINT ( +  ret_20_SYMINT ( +  ret_18_SYMINT ( +  ret_16_SYMINT ( +  ret_14_SYMINT ( +  ret_12_SYMINT ( +  ret_10_SYMINT ( +  ret_8_SYMINT ( +  ret_6_SYMINT ret_4_SYMINT))))))))))))))))))
...
;                  (not (= x!1 (- 7)))
;                  (not (= x!1 (- 5))))))
;      (a!2 (seq.++ (seq.unit (- 2147482013))
;                   (seq.++ (seq.unit (- 2147481353))
;                           (seq.++ (seq.unit (- 2147477868))
;                                   (seq.unit (- 2147481560)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147475522))
;                   (seq.++ (seq.unit (- 2147475535))
;                           (seq.++ (seq.unit (- 2147483647)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477327))
;                   (seq.++ (seq.unit (- 2147476418))
;                           (seq.++ (seq.unit (- 2147474133)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147474060))
;                   (seq.++ (seq.unit (- 2147474685))
;                           (seq.++ (seq.unit (- 2147477118)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147479457))
;                   (seq.++ (seq.unit (- 2147474196))
;                           (seq.++ (seq.unit (- 2147482925)) a!5)))))
;  (List_Int a!1 (seq.++ (seq.unit (- 2147477172)) a!6))))))))
