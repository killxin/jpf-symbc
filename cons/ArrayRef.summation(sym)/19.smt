...
;
(declare-const retMain_39_SYMINT Int)
(assert (= retMain_39_SYMINT ( +  ret_38_SYMINT ( +  ret_36_SYMINT ( +  ret_34_SYMINT ( +  ret_32_SYMINT ( +  ret_30_SYMINT ( +  ret_28_SYMINT ( +  ret_26_SYMINT ( +  ret_24_SYMINT ( +  ret_22_SYMINT ( +  ret_20_SYMINT ( +  ret_18_SYMINT ( +  ret_16_SYMINT ( +  ret_14_SYMINT ( +  ret_12_SYMINT ( +  ret_10_SYMINT ( +  ret_8_SYMINT ( +  ret_6_SYMINT ret_4_SYMINT)))))))))))))))))))
...
;                  (not (= x!1 (- 5)))
;                  (not (= x!1 3)))))
;      (a!2 (seq.++ (seq.unit (- 2147477744))
;                   (seq.++ (seq.unit (- 2147476736))
;                           (seq.++ (seq.unit (- 2147479313))
;                                   (seq.unit (- 2147476456)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482222))
;                   (seq.++ (seq.unit (- 2147482808))
;                           (seq.++ (seq.unit (- 2147478284)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481040))
;                   (seq.++ (seq.unit (- 2147478314))
;                           (seq.++ (seq.unit (- 2147477587)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147474713))
;                   (seq.++ (seq.unit (- 2147482320))
;                           (seq.++ (seq.unit (- 2147475847)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147476579))
;                   (seq.++ (seq.unit (- 2147475513))
;                           (seq.++ (seq.unit (- 2147482247)) a!5)))))
;  (List_Int a!1
;            (seq.++ (seq.unit (- 2147474142))
;                    (seq.++ (seq.unit (- 2147474947)) a!6)))))))))
