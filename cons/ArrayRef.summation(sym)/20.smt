...
;
(declare-const retMain_41_SYMINT Int)
(assert (= retMain_41_SYMINT ( +  ret_40_SYMINT ( +  ret_38_SYMINT ( +  ret_36_SYMINT ( +  ret_34_SYMINT ( +  ret_32_SYMINT ( +  ret_30_SYMINT ( +  ret_28_SYMINT ( +  ret_26_SYMINT ( +  ret_24_SYMINT ( +  ret_22_SYMINT ( +  ret_20_SYMINT ( +  ret_18_SYMINT ( +  ret_16_SYMINT ( +  ret_14_SYMINT ( +  ret_12_SYMINT ( +  ret_10_SYMINT ( +  ret_8_SYMINT ( +  ret_6_SYMINT ret_4_SYMINT))))))))))))))))))))
...
;                  (not (= x!1 (- 1)))
;                  (not (= x!1 (- 11))))))
;      (a!2 (seq.++ (seq.unit (- 2147477969))
;                   (seq.++ (seq.unit (- 2147479112))
;                           (seq.++ (seq.unit (- 2147482070))
;                                   (seq.unit (- 2147477263)))))))
;(let ((a!3 (seq.++ (seq.unit (- 2147481161))
;                   (seq.++ (seq.unit (- 2147475088))
;                           (seq.++ (seq.unit (- 2147477938)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147477954))
;                   (seq.++ (seq.unit (- 2147481449))
;                           (seq.++ (seq.unit (- 2147481310)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147481536))
;                   (seq.++ (seq.unit (- 2147481800))
;                           (seq.++ (seq.unit (- 2147476962)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147481185))
;                   (seq.++ (seq.unit (- 2147478501))
;                           (seq.++ (seq.unit (- 2147481586)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147475706))
;                   (seq.++ (seq.unit (- 2147478069))
;                           (seq.++ (seq.unit (- 2147479416)) a!6)))))
;  (List_Int a!1 a!7))))))))
