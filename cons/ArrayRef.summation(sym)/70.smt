...
;  (let ((a!1 (seq.++ (seq.unit (- 2147475577))
;                   (seq.++ (seq.unit (- 2147478425))
;                           (seq.++ (seq.unit (- 2147474605))
;                                   (seq.unit (- 2147478177)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481175))
;                   (seq.++ (seq.unit (- 2147477854))
;                           (seq.++ (seq.unit (- 2147480606)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482734))
;                   (seq.++ (seq.unit (- 2147477903))
;                           (seq.++ (seq.unit (- 2147475539)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147474041))
;                   (seq.++ (seq.unit (- 2147477656))
;                           (seq.++ (seq.unit (- 2147478049)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147478114))
;                   (seq.++ (seq.unit (- 2147477335))
;                           (seq.++ (seq.unit (- 2147483034)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147482651))
;                   (seq.++ (seq.unit (- 2147474927))
;                           (seq.++ (seq.unit (- 2147473677)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147480607))
;                   (seq.++ (seq.unit (- 2147476064))
;                           (seq.++ (seq.unit (- 2147482392)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147478897))
;                   (seq.++ (seq.unit (- 2147476085))
;                           (seq.++ (seq.unit (- 2147478818)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147481041))
;                   (seq.++ (seq.unit (- 2147479663))
;                           (seq.++ (seq.unit (- 2147482046)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147475064))
;                    (seq.++ (seq.unit (- 2147476007))
;                            (seq.++ (seq.unit (- 2147478813)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147482460))
;                    (seq.++ (seq.unit (- 2147483471))
;                            (seq.++ (seq.unit (- 2147476905)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147479839))
;                    (seq.++ (seq.unit (- 2147482114))
;                            (seq.++ (seq.unit (- 2147477561)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147478249))
;                    (seq.++ (seq.unit (- 2147479036))
;                            (seq.++ (seq.unit (- 2147479218)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147482251))
;                    (seq.++ (seq.unit (- 2147478142))
;                            (seq.++ (seq.unit (- 2147482329)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147480205))
;                    (seq.++ (seq.unit (- 2147479451))
;                            (seq.++ (seq.unit (- 2147474963)) a!14)))))
;(let ((a!16 (seq.++ (seq.unit (- 2147476460))
;                    (seq.++ (seq.unit (- 2147475400))
;                            (seq.++ (seq.unit (- 2147476678)) a!15)))))
;(let ((a!17 (seq.++ (seq.unit (- 2147479899))
;                    (seq.++ (seq.unit (- 2147482779))
;                            (seq.++ (seq.unit (- 2147481562)) a!16)))))
;(let ((a!18 (seq.++ (seq.unit (- 2147482692))
;                    (seq.++ (seq.unit (- 2147482171))
;                            (seq.++ (seq.unit (- 2147474378)) a!17)))))
;(let ((a!19 (seq.++ (seq.unit (- 2147476996))
;                    (seq.++ (seq.unit (- 2147476024))
;                            (seq.++ (seq.unit (- 2147481561)) a!18)))))
;(let ((a!20 (seq.++ (seq.unit (- 2147479689))
;                    (seq.++ (seq.unit (- 2147480819))
;                            (seq.++ (seq.unit (- 2147475061)) a!19)))))
;(let ((a!21 (seq.++ (seq.unit (- 2147477047))
;                    (seq.++ (seq.unit (- 2147478398))
;                            (seq.++ (seq.unit (- 2147476442)) a!20)))))
;(let ((a!22 (seq.++ (seq.unit (- 2147482165))
;                    (seq.++ (seq.unit (- 2147476884))
;                            (seq.++ (seq.unit (- 2147478720)) a!21)))))
