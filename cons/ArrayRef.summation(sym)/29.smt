...
;  (let ((a!1 (seq.++ (seq.unit (- 2147483229))
;                   (seq.++ (seq.unit (- 2147481649))
;                           (seq.++ (seq.unit (- 2147479197))
;                                   (seq.unit (- 2147477103)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481368))
;                   (seq.++ (seq.unit (- 2147483531))
;                           (seq.++ (seq.unit (- 2147474529)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147478310))
;                   (seq.++ (seq.unit (- 2147478037))
;                           (seq.++ (seq.unit (- 2147475884)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147478074))
;                   (seq.++ (seq.unit (- 2147481357))
;                           (seq.++ (seq.unit (- 2147480460)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147474435))
;                   (seq.++ (seq.unit (- 2147474693))
;                           (seq.++ (seq.unit (- 2147478332)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147483522))
;                   (seq.++ (seq.unit (- 2147474608))
;                           (seq.++ (seq.unit (- 2147481899)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147478498))
;                   (seq.++ (seq.unit (- 2147476967))
;                           (seq.++ (seq.unit (- 2147478839)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147479821))
;                   (seq.++ (seq.unit (- 2147473885))
;                           (seq.++ (seq.unit (- 2147483604)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147476613))
;                   (seq.++ (seq.unit (- 2147474448))
;                           (seq.++ (seq.unit (- 2147479028)) a!8)))))
