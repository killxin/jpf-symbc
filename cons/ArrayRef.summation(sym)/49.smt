...
;  (let ((a!1 (seq.++ (seq.unit (- 2147482585))
;                   (seq.++ (seq.unit (- 2147479342))
;                           (seq.++ (seq.unit (- 2147479187))
;                                   (seq.unit (- 2147481964)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147477726))
;                   (seq.++ (seq.unit (- 2147483457))
;                           (seq.++ (seq.unit (- 2147475238)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147478239))
;                   (seq.++ (seq.unit (- 2147481476))
;                           (seq.++ (seq.unit (- 2147479793)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147479423))
;                   (seq.++ (seq.unit (- 2147480597))
;                           (seq.++ (seq.unit (- 2147483162)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147481548))
;                   (seq.++ (seq.unit (- 2147482054))
;                           (seq.++ (seq.unit (- 2147475061)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147473951))
;                   (seq.++ (seq.unit (- 2147476332))
;                           (seq.++ (seq.unit (- 2147479987)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147481872))
;                   (seq.++ (seq.unit (- 2147480935))
;                           (seq.++ (seq.unit (- 2147482170)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147481148))
;                   (seq.++ (seq.unit (- 2147479120))
;                           (seq.++ (seq.unit (- 2147482984)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147480471))
;                   (seq.++ (seq.unit (- 2147475267))
;                           (seq.++ (seq.unit (- 2147483582)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147482644))
;                    (seq.++ (seq.unit (- 2147474684))
;                            (seq.++ (seq.unit (- 2147479433)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147480373))
;                    (seq.++ (seq.unit (- 2147474071))
;                            (seq.++ (seq.unit (- 2147477050)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147477145))
;                    (seq.++ (seq.unit (- 2147482257))
;                            (seq.++ (seq.unit (- 2147476611)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147483068))
;                    (seq.++ (seq.unit (- 2147477051))
;                            (seq.++ (seq.unit (- 2147480779)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147481155))
;                    (seq.++ (seq.unit (- 2147479040))
;                            (seq.++ (seq.unit (- 2147474012)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147481542))
;                    (seq.++ (seq.unit (- 2147475842))
;                            (seq.++ (seq.unit (- 2147480239)) a!14)))))
...
;                  (= x!1 (- 7))
;                  (= x!1 (- 5))))
;            (seq.++ (seq.unit (- 2147480415))
;                    (seq.++ (seq.unit (- 2147477311)) a!15)))))))))))))))))))
