...
;  (let ((a!1 (seq.++ (seq.unit (- 2147478463))
;                   (seq.++ (seq.unit (- 2147474443))
;                           (seq.++ (seq.unit (- 2147477567))
;                                   (seq.unit (- 2147483265)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147477477))
;                   (seq.++ (seq.unit (- 2147475902))
;                           (seq.++ (seq.unit (- 2147473660)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477033))
;                   (seq.++ (seq.unit (- 2147480511))
;                           (seq.++ (seq.unit (- 2147477516)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147482694))
;                   (seq.++ (seq.unit (- 2147476564))
;                           (seq.++ (seq.unit (- 2147475157)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147479023))
;                   (seq.++ (seq.unit (- 2147479960))
;                           (seq.++ (seq.unit (- 2147481457)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147479531))
;                   (seq.++ (seq.unit (- 2147479201))
;                           (seq.++ (seq.unit (- 2147481895)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147476497))
;                   (seq.++ (seq.unit (- 2147475663))
;                           (seq.++ (seq.unit (- 2147481952)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147478085))
;                   (seq.++ (seq.unit (- 2147478522))
;                           (seq.++ (seq.unit (- 2147481090)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147475805))
;                   (seq.++ (seq.unit (- 2147477115))
;                           (seq.++ (seq.unit (- 2147480741)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147481698))
;                    (seq.++ (seq.unit (- 2147478430))
;                            (seq.++ (seq.unit (- 2147479101)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147477549))
;                    (seq.++ (seq.unit (- 2147483274))
;                            (seq.++ (seq.unit (- 2147477792)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147482387))
;                    (seq.++ (seq.unit (- 2147480326))
;                            (seq.++ (seq.unit (- 2147476748)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147477608))
;                    (seq.++ (seq.unit (- 2147475557))
;                            (seq.++ (seq.unit (- 2147475647)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147478846))
;                    (seq.++ (seq.unit (- 2147476395))
;                            (seq.++ (seq.unit (- 2147473749)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147483511))
;                    (seq.++ (seq.unit (- 2147481984))
;                            (seq.++ (seq.unit (- 2147479734)) a!14)))))
;(let ((a!16 (seq.++ (seq.unit (- 2147481699))
;                    (seq.++ (seq.unit (- 2147478391))
;                            (seq.++ (seq.unit (- 2147479731)) a!15)))))
;(let ((a!17 (seq.++ (seq.unit (- 2147480991))
;                    (seq.++ (seq.unit (- 2147482752))
;                            (seq.++ (seq.unit (- 2147481416)) a!16)))))
;(let ((a!18 (seq.++ (seq.unit (- 2147478916))
;                    (seq.++ (seq.unit (- 2147483473))
;                            (seq.++ (seq.unit (- 2147476499)) a!17)))))
;(let ((a!19 (seq.++ (seq.unit (- 2147476917))
;                    (seq.++ (seq.unit (- 2147477463))
;                            (seq.++ (seq.unit (- 2147478895)) a!18)))))
;(let ((a!20 (seq.++ (seq.unit (- 2147482090))
;                    (seq.++ (seq.unit (- 2147479375))
;                            (seq.++ (seq.unit (- 2147476368)) a!19)))))
;(let ((a!21 (seq.++ (seq.unit (- 2147476956))
;                    (seq.++ (seq.unit (- 2147475893))
;                            (seq.++ (seq.unit (- 2147475336)) a!20)))))
;(let ((a!22 (seq.++ (seq.unit (- 2147483605))
;                    (seq.++ (seq.unit (- 2147477392))
;                            (seq.++ (seq.unit (- 2147475555)) a!21)))))
;(let ((a!23 (seq.++ (seq.unit (- 2147473715))
;                    (seq.++ (seq.unit (- 2147474853))
;                            (seq.++ (seq.unit (- 2147479955)) a!22)))))
;(let ((a!24 (seq.++ (seq.unit (- 2147483201))
;                    (seq.++ (seq.unit (- 2147477223))
;                            (seq.++ (seq.unit (- 2147474919)) a!23)))))
...
;                  (= x!1 3)
;                  (= x!1 5)))
;            (seq.++ (seq.unit (- 2147478587))
;                    (seq.++ (seq.unit (- 2147478303)) a!24))))))))))))))))))))))))))))
