...
;
(declare-const retMain_33_SYMINT Int)
(assert (= retMain_33_SYMINT ( +  ret_32_SYMINT ( +  ret_30_SYMINT ( +  ret_28_SYMINT ( +  ret_26_SYMINT ( +  ret_24_SYMINT ( +  ret_22_SYMINT ( +  ret_20_SYMINT ( +  ret_18_SYMINT ( +  ret_16_SYMINT ( +  ret_14_SYMINT ( +  ret_12_SYMINT ( +  ret_10_SYMINT ( +  ret_8_SYMINT ( +  ret_6_SYMINT ret_4_SYMINT))))))))))))))))
...
;  (let ((a!1 (seq.++ (seq.unit (- 2147476867))
;                   (seq.++ (seq.unit (- 2147481072))
;                           (seq.++ (seq.unit (- 2147477631))
;                                   (seq.unit (- 2147483398)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147476441))
;                   (seq.++ (seq.unit (- 2147483057))
;                           (seq.++ (seq.unit (- 2147474762)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147479153))
;                   (seq.++ (seq.unit (- 2147481973))
;                           (seq.++ (seq.unit (- 2147475244)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147475529))
;                   (seq.++ (seq.unit (- 2147483174))
;                           (seq.++ (seq.unit (- 2147474314)) a!3)))))
...
;                  (= x!1 (- 7))
;                  (= x!1 5)))
;            (seq.++ (seq.unit (- 2147481018))
;                    (seq.++ (seq.unit (- 2147476624)) a!4))))))))
