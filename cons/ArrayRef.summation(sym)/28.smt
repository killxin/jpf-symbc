...
;
(declare-const retMain_57_SYMINT Int)
(assert (= retMain_57_SYMINT ( +  ret_56_SYMINT ( +  ret_54_SYMINT ( +  ret_52_SYMINT ( +  ret_50_SYMINT ( +  ret_48_SYMINT ( +  ret_46_SYMINT ( +  ret_44_SYMINT ( +  ret_42_SYMINT ( +  ret_40_SYMINT ( +  ret_38_SYMINT ( +  ret_36_SYMINT ( +  ret_34_SYMINT ( +  ret_32_SYMINT ( +  ret_30_SYMINT ( +  ret_28_SYMINT ( +  ret_26_SYMINT ( +  ret_24_SYMINT ( +  ret_22_SYMINT ( +  ret_20_SYMINT ( +  ret_18_SYMINT ( +  ret_16_SYMINT ( +  ret_14_SYMINT ( +  ret_12_SYMINT ( +  ret_10_SYMINT ( +  ret_8_SYMINT ( +  ret_6_SYMINT ret_4_SYMINT))))))))))))))))))))))))))))
;(define-fun length_2_SYMINT () Int
;  27)
;(define-fun ret_10_SYMINT () Int
;  (- 2147483145))
;(define-fun numbers_1_SYMARRAY () List_Int
;  (let ((a!1 (seq.++ (seq.unit (- 2147481628))
;                   (seq.++ (seq.unit (- 2147483041))
;                           (seq.++ (seq.unit (- 2147474967))
;                                   (seq.unit (- 2147481220)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481177))
;                   (seq.++ (seq.unit (- 2147474289))
;                           (seq.++ (seq.unit (- 2147480013)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147477302))
;                   (seq.++ (seq.unit (- 2147481517))
;                           (seq.++ (seq.unit (- 2147479468)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147483508))
;                   (seq.++ (seq.unit (- 2147480200))
;                           (seq.++ (seq.unit (- 2147480951)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147481636))
;                   (seq.++ (seq.unit (- 2147481601))
;                           (seq.++ (seq.unit (- 2147480172)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147477590))
;                   (seq.++ (seq.unit (- 2147475078))
;                           (seq.++ (seq.unit (- 2147479616)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147479348))
;                   (seq.++ (seq.unit (- 2147478938))
;                           (seq.++ (seq.unit (- 2147475879)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147476027))
;                   (seq.++ (seq.unit (- 2147483145))
;                           (seq.++ (seq.unit (- 2147480517)) a!7)))))
...
;                  (= x!1 (- 11))
;                  (= x!1 3)))
;            (seq.++ (seq.unit (- 2147481188))
;                    (seq.++ (seq.unit (- 2147478436)) a!8))))))))))))
