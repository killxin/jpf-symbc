...
;  (let ((a!1 (seq.++ (seq.unit (- 2147476062))
;                   (seq.++ (seq.unit (- 2147480715))
;                           (seq.++ (seq.unit (- 2147481199))
;                                   (seq.unit (- 2147479227)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147483548))
;                   (seq.++ (seq.unit (- 2147478667))
;                           (seq.++ (seq.unit (- 2147474907)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147478322))
;                   (seq.++ (seq.unit (- 2147482735))
;                           (seq.++ (seq.unit (- 2147475683)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147481757))
;                   (seq.++ (seq.unit (- 2147479443))
;                           (seq.++ (seq.unit (- 2147473825)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147476156))
;                   (seq.++ (seq.unit (- 2147474050))
;                           (seq.++ (seq.unit (- 2147475579)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147476914))
;                   (seq.++ (seq.unit (- 2147477924))
;                           (seq.++ (seq.unit (- 2147482715)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147480147))
;                   (seq.++ (seq.unit (- 2147475898))
;                           (seq.++ (seq.unit (- 2147476987)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147474413))
;                   (seq.++ (seq.unit (- 2147483492))
;                           (seq.++ (seq.unit (- 2147481672)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147476348))
;                   (seq.++ (seq.unit (- 2147477389))
;                           (seq.++ (seq.unit (- 2147474308)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147476010))
;                    (seq.++ (seq.unit (- 2147481607))
;                            (seq.++ (seq.unit (- 2147482400)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147478629))
;                    (seq.++ (seq.unit (- 2147474275))
;                            (seq.++ (seq.unit (- 2147478425)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147482761))
;                    (seq.++ (seq.unit (- 2147481171))
;                            (seq.++ (seq.unit (- 2147479509)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147476489))
;                    (seq.++ (seq.unit (- 2147475758))
;                            (seq.++ (seq.unit (- 2147483459)) a!12)))))
;(let ((a!14 (seq.++ (seq.unit (- 2147482519))
;                    (seq.++ (seq.unit (- 2147479650))
;                            (seq.++ (seq.unit (- 2147482567)) a!13)))))
;(let ((a!15 (seq.++ (seq.unit (- 2147478658))
;                    (seq.++ (seq.unit (- 2147474746))
;                            (seq.++ (seq.unit (- 2147476046)) a!14)))))
;(let ((a!16 (seq.++ (seq.unit (- 2147479463))
;                    (seq.++ (seq.unit (- 2147477209))
;                            (seq.++ (seq.unit (- 2147473933)) a!15)))))
;(let ((a!17 (seq.++ (seq.unit (- 2147481407))
;                    (seq.++ (seq.unit (- 2147479158))
;                            (seq.++ (seq.unit (- 2147475732)) a!16)))))
;(let ((a!18 (seq.++ (seq.unit (- 2147479659))
;                    (seq.++ (seq.unit (- 2147473927))
;                            (seq.++ (seq.unit (- 2147479601)) a!17)))))
;(let ((a!19 (seq.++ (seq.unit (- 2147480171))
;                    (seq.++ (seq.unit (- 2147483617))
;                            (seq.++ (seq.unit (- 2147480456)) a!18)))))
