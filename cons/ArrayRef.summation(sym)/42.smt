...
;  (let ((a!1 (seq.++ (seq.unit (- 2147477242))
;                   (seq.++ (seq.unit (- 2147481504))
;                           (seq.++ (seq.unit (- 2147482647))
;                                   (seq.unit (- 2147476943)))))))
;(let ((a!2 (seq.++ (seq.unit (- 2147481870))
;                   (seq.++ (seq.unit (- 2147482587))
;                           (seq.++ (seq.unit (- 2147478141)) a!1)))))
;(let ((a!3 (seq.++ (seq.unit (- 2147482698))
;                   (seq.++ (seq.unit (- 2147477975))
;                           (seq.++ (seq.unit (- 2147483579)) a!2)))))
;(let ((a!4 (seq.++ (seq.unit (- 2147476025))
;                   (seq.++ (seq.unit (- 2147480994))
;                           (seq.++ (seq.unit (- 2147475962)) a!3)))))
;(let ((a!5 (seq.++ (seq.unit (- 2147474325))
;                   (seq.++ (seq.unit (- 2147474909))
;                           (seq.++ (seq.unit (- 2147477838)) a!4)))))
;(let ((a!6 (seq.++ (seq.unit (- 2147476904))
;                   (seq.++ (seq.unit (- 2147477228))
;                           (seq.++ (seq.unit (- 2147475021)) a!5)))))
;(let ((a!7 (seq.++ (seq.unit (- 2147479302))
;                   (seq.++ (seq.unit (- 2147475983))
;                           (seq.++ (seq.unit (- 2147476757)) a!6)))))
;(let ((a!8 (seq.++ (seq.unit (- 2147478257))
;                   (seq.++ (seq.unit (- 2147482265))
;                           (seq.++ (seq.unit (- 2147478560)) a!7)))))
;(let ((a!9 (seq.++ (seq.unit (- 2147477570))
;                   (seq.++ (seq.unit (- 2147476242))
;                           (seq.++ (seq.unit (- 2147477698)) a!8)))))
;(let ((a!10 (seq.++ (seq.unit (- 2147477639))
;                    (seq.++ (seq.unit (- 2147481005))
;                            (seq.++ (seq.unit (- 2147480443)) a!9)))))
;(let ((a!11 (seq.++ (seq.unit (- 2147479681))
;                    (seq.++ (seq.unit (- 2147481536))
;                            (seq.++ (seq.unit (- 2147474352)) a!10)))))
;(let ((a!12 (seq.++ (seq.unit (- 2147475277))
;                    (seq.++ (seq.unit (- 2147474458))
;                            (seq.++ (seq.unit (- 2147476472)) a!11)))))
;(let ((a!13 (seq.++ (seq.unit (- 2147482906))
;                    (seq.++ (seq.unit (- 2147473811))
;                            (seq.++ (seq.unit (- 2147473827)) a!12)))))
