...
public enum LibraryOperation {
	...
	ARRAYLIST_LISTITERATOR("java.util.ArrayList.listIterator()Ljava/util/ListIterator;"),
	ARRAYLIST_LISTITERATOR2("java.util.ArrayList.listIterator(I)Ljava/util/ListIterator;"),
	...
	STRING_INIT3("java.lang.String.<init>([C)V"),
	STRING_INIT4("java.lang.String.<init>([CII)V"),
	STRING_INIT5("java.lang.String.<init>([III)V"),
	STRING_INIT6("java.lang.String.<init>([BIII)V"),
	STRING_INIT7("java.lang.String.<init>([BI)V"),
	STRING_CHECKBOUNDS("java.lang.String.checkBounds([BII)V"),
	STRING_INIT8("java.lang.String.<init>([BIILjava/lang/String;)V"),
	STRING_INIT9("java.lang.String.<init>([BIILjava/nio/charset/Charset;)V"),
	STRING_INIT10("java.lang.String.<init>([BLjava/lang/String;)V"),
	STRING_INIT11("java.lang.String.<init>([BLjava/nio/charset/Charset;)V"),
	STRING_INIT12("java.lang.String.<init>([BII)V"),
	STRING_INIT13("java.lang.String.<init>([B)V"),
	STRING_INIT14("java.lang.String.<init>(Ljava/lang/StringBuffer;)V"),
	STRING_INIT15("java.lang.String.<init>(Ljava/lang/StringBuilder;)V"),
	STRING_INIT16("java.lang.String.<init>([CZ)V"),
	STRING_LENGTH("java.lang.String.length()I"),
	STRING_ISEMPTY("java.lang.String.isEmpty()Z"),
	STRING_CHARAT("java.lang.String.charAt(I)C"),
	STRING_CODEPOINTAT("java.lang.String.codePointAt(I)I"),
	STRING_CODEPOINTBEFORE("java.lang.String.codePointBefore(I)I"),
	STRING_CODEPOINTCOUNT("java.lang.String.codePointCount(II)I"),
	STRING_OFFSETBYCODEPOINTS("java.lang.String.offsetByCodePoints(II)I"),
	STRING_GETCHARS("java.lang.String.getChars([CI)V"),
	STRING_GETCHARS2("java.lang.String.getChars(II[CI)V"),
	STRING_GETBYTES("java.lang.String.getBytes(II[BI)V"),
	STRING_GETBYTES2("java.lang.String.getBytes(Ljava/lang/String;)[B"),
	STRING_GETBYTES3("java.lang.String.getBytes(Ljava/nio/charset/Charset;)[B"),
	STRING_GETBYTES4("java.lang.String.getBytes()[B"),
	STRING_EQUALS("java.lang.String.equals(Ljava/lang/Object;)Z"),
	STRING_CONTENTEQUALS("java.lang.String.contentEquals(Ljava/lang/StringBuffer;)Z"),
	STRING_CONTENTEQUALS2("java.lang.String.contentEquals(Ljava/lang/CharSequence;)Z"),
	STRING_EQUALSIGNORECASE("java.lang.String.equalsIgnoreCase(Ljava/lang/String;)Z"),
	STRING_COMPARETO("java.lang.String.compareTo(Ljava/lang/String;)I"),
	STRING_COMPARETOIGNORECASE("java.lang.String.compareToIgnoreCase(Ljava/lang/String;)I"),
	STRING_REGIONMATCHES("java.lang.String.regionMatches(ILjava/lang/String;II)Z"),
	STRING_REGIONMATCHES2("java.lang.String.regionMatches(ZILjava/lang/String;II)Z"),
	STRING_STARTSWITH("java.lang.String.startsWith(Ljava/lang/String;I)Z"),
	STRING_STARTSWITH2("java.lang.String.startsWith(Ljava/lang/String;)Z"),
	STRING_ENDSWITH("java.lang.String.endsWith(Ljava/lang/String;)Z"),
	STRING_HASHCODE("java.lang.String.hashCode()I"),
	STRING_INDEXOF("java.lang.String.indexOf(I)I"),
	STRING_INDEXOF2("java.lang.String.indexOf(II)I"),
	STRING_LASTINDEXOF("java.lang.String.lastIndexOf(I)I"),
	STRING_LASTINDEXOF2("java.lang.String.lastIndexOf(II)I"),
	STRING_INDEXOF3("java.lang.String.indexOf(Ljava/lang/String;)I"),
	STRING_INDEXOF4("java.lang.String.indexOf(Ljava/lang/String;I)I"),
	STRING_INDEXOF5("java.lang.String.indexOf([CIILjava/lang/String;I)I"),
	STRING_INDEXOF6("java.lang.String.indexOf([CII[CIII)I"),
	STRING_LASTINDEXOF3("java.lang.String.lastIndexOf(Ljava/lang/String;)I"),
	STRING_LASTINDEXOF4("java.lang.String.lastIndexOf(Ljava/lang/String;I)I"),
	STRING_LASTINDEXOF5("java.lang.String.lastIndexOf([CIILjava/lang/String;I)I"),
	STRING_LASTINDEXOF6("java.lang.String.lastIndexOf([CII[CIII)I"),
	STRING_SUBSTRING("java.lang.String.substring(I)Ljava/lang/String;"),
	STRING_SUBSTRING2("java.lang.String.substring(II)Ljava/lang/String;"),
	STRING_SUBSEQUENCE("java.lang.String.subSequence(II)Ljava/lang/CharSequence;"),
	STRING_CONCAT("java.lang.String.concat(Ljava/lang/String;)Ljava/lang/String;"),
	STRING_REPLACE("java.lang.String.replace(CC)Ljava/lang/String;"),
	STRING_MATCHES("java.lang.String.matches(Ljava/lang/String;)Z"),
	STRING_CONTAINS("java.lang.String.contains(Ljava/lang/CharSequence;)Z"),
	STRING_REPLACEFIRST("java.lang.String.replaceFirst(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;"),
	STRING_REPLACEALL("java.lang.String.replaceAll(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;"),
	STRING_REPLACE2("java.lang.String.replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;"),
	STRING_SPLIT("java.lang.String.split(Ljava/lang/String;I)[Ljava/lang/String;"),
	STRING_SPLIT2("java.lang.String.split(Ljava/lang/String;)[Ljava/lang/String;"),
	STRING_JOIN("java.lang.String.join(Ljava/lang/CharSequence;[Ljava/lang/CharSequence;)Ljava/lang/String;"),
	STRING_JOIN2("java.lang.String.join(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;"),
	STRING_TOLOWERCASE("java.lang.String.toLowerCase(Ljava/util/Locale;)Ljava/lang/String;"),
	STRING_TOLOWERCASE2("java.lang.String.toLowerCase()Ljava/lang/String;"),
	STRING_TOUPPERCASE("java.lang.String.toUpperCase(Ljava/util/Locale;)Ljava/lang/String;"),
	STRING_TOUPPERCASE2("java.lang.String.toUpperCase()Ljava/lang/String;"),
	STRING_TRIM("java.lang.String.trim()Ljava/lang/String;"),
	STRING_TOSTRING("java.lang.String.toString()Ljava/lang/String;"),
	STRING_TOCHARARRAY("java.lang.String.toCharArray()[C"),
	STRING_FORMAT("java.lang.String.format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;"),
	STRING_FORMAT2("java.lang.String.format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;"),
	STRING_VALUEOF("java.lang.String.valueOf(Ljava/lang/Object;)Ljava/lang/String;"),
	STRING_VALUEOF2("java.lang.String.valueOf([C)Ljava/lang/String;"),
	STRING_VALUEOF3("java.lang.String.valueOf([CII)Ljava/lang/String;"),
	STRING_COPYVALUEOF("java.lang.String.copyValueOf([CII)Ljava/lang/String;"),
	STRING_COPYVALUEOF2("java.lang.String.copyValueOf([C)Ljava/lang/String;"),
	STRING_VALUEOF4("java.lang.String.valueOf(Z)Ljava/lang/String;"),
	STRING_VALUEOF5("java.lang.String.valueOf(C)Ljava/lang/String;"),
	STRING_VALUEOF6("java.lang.String.valueOf(I)Ljava/lang/String;"),
	STRING_VALUEOF7("java.lang.String.valueOf(J)Ljava/lang/String;"),
	STRING_VALUEOF8("java.lang.String.valueOf(F)Ljava/lang/String;"),
	STRING_VALUEOF9("java.lang.String.valueOf(D)Ljava/lang/String;"),
	STRING_INTERN("java.lang.String.intern()Ljava/lang/String;"),
	STRING_COMPARETO2("java.lang.String.compareTo(Ljava/lang/Object;)I"),
	STRING_CLINIT("java.lang.String.<clinit>()V"),
	STRINGBUILDER_INIT("java.lang.StringBuilder.<init>()V"),
	STRINGBUILDER_INIT2("java.lang.StringBuilder.<init>(I)V"),
	STRINGBUILDER_INIT3("java.lang.StringBuilder.<init>(Ljava/lang/String;)V"),
	STRINGBUILDER_INIT4("java.lang.StringBuilder.<init>(Ljava/lang/CharSequence;)V"),
	STRINGBUILDER_APPEND("java.lang.StringBuilder.append(Ljava/lang/Object;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND2("java.lang.StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND3("java.lang.StringBuilder.append(Ljava/lang/StringBuffer;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND4("java.lang.StringBuilder.append(Ljava/lang/CharSequence;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND5("java.lang.StringBuilder.append(Ljava/lang/CharSequence;II)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND6("java.lang.StringBuilder.append([C)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND7("java.lang.StringBuilder.append([CII)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND8("java.lang.StringBuilder.append(Z)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND9("java.lang.StringBuilder.append(C)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND10("java.lang.StringBuilder.append(I)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND11("java.lang.StringBuilder.append(J)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND12("java.lang.StringBuilder.append(F)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPEND13("java.lang.StringBuilder.append(D)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_APPENDCODEPOINT("java.lang.StringBuilder.appendCodePoint(I)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_DELETE("java.lang.StringBuilder.delete(II)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_DELETECHARAT("java.lang.StringBuilder.deleteCharAt(I)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_REPLACE("java.lang.StringBuilder.replace(IILjava/lang/String;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT("java.lang.StringBuilder.insert(I[CII)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT2("java.lang.StringBuilder.insert(ILjava/lang/Object;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT3("java.lang.StringBuilder.insert(ILjava/lang/String;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT4("java.lang.StringBuilder.insert(I[C)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT5("java.lang.StringBuilder.insert(ILjava/lang/CharSequence;)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT6("java.lang.StringBuilder.insert(ILjava/lang/CharSequence;II)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT7("java.lang.StringBuilder.insert(IZ)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT8("java.lang.StringBuilder.insert(IC)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT9("java.lang.StringBuilder.insert(II)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT10("java.lang.StringBuilder.insert(IJ)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT11("java.lang.StringBuilder.insert(IF)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INSERT12("java.lang.StringBuilder.insert(ID)Ljava/lang/StringBuilder;"),
	STRINGBUILDER_INDEXOF("java.lang.StringBuilder.indexOf(Ljava/lang/String;)I"),
	STRINGBUILDER_INDEXOF2("java.lang.StringBuilder.indexOf(Ljava/lang/String;I)I"),
	STRINGBUILDER_LASTINDEXOF("java.lang.StringBuilder.lastIndexOf(Ljava/lang/String;)I"),
	STRINGBUILDER_LASTINDEXOF2("java.lang.StringBuilder.lastIndexOf(Ljava/lang/String;I)I"),
	STRINGBUILDER_REVERSE("java.lang.StringBuilder.reverse()Ljava/lang/StringBuilder;"),
	STRINGBUILDER_TOSTRING("java.lang.StringBuilder.toString()Ljava/lang/String;"),
	STRINGBUILDER_REVERSE2("java.lang.StringBuilder.reverse()Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT13("java.lang.StringBuilder.insert(ID)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT14("java.lang.StringBuilder.insert(IF)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT15("java.lang.StringBuilder.insert(IJ)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT16("java.lang.StringBuilder.insert(II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT17("java.lang.StringBuilder.insert(IC)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT18("java.lang.StringBuilder.insert(IZ)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT19("java.lang.StringBuilder.insert(ILjava/lang/CharSequence;II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT20("java.lang.StringBuilder.insert(ILjava/lang/CharSequence;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT21("java.lang.StringBuilder.insert(I[C)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT22("java.lang.StringBuilder.insert(ILjava/lang/String;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT23("java.lang.StringBuilder.insert(ILjava/lang/Object;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_INSERT24("java.lang.StringBuilder.insert(I[CII)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_SUBSTRING("java.lang.StringBuilder.substring(II)Ljava/lang/String;"),
	STRINGBUILDER_SUBSEQUENCE("java.lang.StringBuilder.subSequence(II)Ljava/lang/CharSequence;"),
	STRINGBUILDER_SUBSTRING2("java.lang.StringBuilder.substring(I)Ljava/lang/String;"),
	STRINGBUILDER_REPLACE2("java.lang.StringBuilder.replace(IILjava/lang/String;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_DELETECHARAT2("java.lang.StringBuilder.deleteCharAt(I)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPENDCODEPOINT2("java.lang.StringBuilder.appendCodePoint(I)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_DELETE2("java.lang.StringBuilder.delete(II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND14("java.lang.StringBuilder.append(D)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND15("java.lang.StringBuilder.append(F)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND16("java.lang.StringBuilder.append(J)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND17("java.lang.StringBuilder.append(I)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND18("java.lang.StringBuilder.append(C)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND19("java.lang.StringBuilder.append(Z)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND20("java.lang.StringBuilder.append([CII)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND21("java.lang.StringBuilder.append([C)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND22("java.lang.StringBuilder.append(Ljava/lang/CharSequence;II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND23("java.lang.StringBuilder.append(Ljava/lang/CharSequence;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND24("java.lang.StringBuilder.append(Ljava/lang/StringBuffer;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND25("java.lang.StringBuilder.append(Ljava/lang/String;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_APPEND26("java.lang.StringBuilder.append(Ljava/lang/Object;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUILDER_SETCHARAT("java.lang.StringBuilder.setCharAt(IC)V"),
	STRINGBUILDER_GETCHARS("java.lang.StringBuilder.getChars(II[CI)V"),
	STRINGBUILDER_OFFSETBYCODEPOINTS("java.lang.StringBuilder.offsetByCodePoints(II)I"),
	STRINGBUILDER_CODEPOINTCOUNT("java.lang.StringBuilder.codePointCount(II)I"),
	STRINGBUILDER_CODEPOINTBEFORE("java.lang.StringBuilder.codePointBefore(I)I"),
	STRINGBUILDER_CODEPOINTAT("java.lang.StringBuilder.codePointAt(I)I"),
	STRINGBUILDER_CHARAT("java.lang.StringBuilder.charAt(I)C"),
	STRINGBUILDER_SETLENGTH("java.lang.StringBuilder.setLength(I)V"),
	STRINGBUILDER_TRIMTOSIZE("java.lang.StringBuilder.trimToSize()V"),
	STRINGBUILDER_ENSURECAPACITY("java.lang.StringBuilder.ensureCapacity(I)V"),
	STRINGBUILDER_CAPACITY("java.lang.StringBuilder.capacity()I"),
	STRINGBUILDER_LENGTH("java.lang.StringBuilder.length()I"),
	STRINGBUILDER_APPEND27("java.lang.StringBuilder.append(C)Ljava/lang/Appendable;"),
	STRINGBUILDER_APPEND28("java.lang.StringBuilder.append(Ljava/lang/CharSequence;II)Ljava/lang/Appendable;"),
	STRINGBUILDER_APPEND29("java.lang.StringBuilder.append(Ljava/lang/CharSequence;)Ljava/lang/Appendable;"),
	STRINGBUFFER_INIT("java.lang.StringBuffer.<init>()V"),
	STRINGBUFFER_INIT2("java.lang.StringBuffer.<init>(I)V"),
	STRINGBUFFER_INIT3("java.lang.StringBuffer.<init>(Ljava/lang/String;)V"),
	STRINGBUFFER_INIT4("java.lang.StringBuffer.<init>(Ljava/lang/CharSequence;)V"),
	STRINGBUFFER_LENGTH("java.lang.StringBuffer.length()I"),
	STRINGBUFFER_CAPACITY("java.lang.StringBuffer.capacity()I"),
	STRINGBUFFER_ENSURECAPACITY("java.lang.StringBuffer.ensureCapacity(I)V"),
	STRINGBUFFER_TRIMTOSIZE("java.lang.StringBuffer.trimToSize()V"),
	STRINGBUFFER_SETLENGTH("java.lang.StringBuffer.setLength(I)V"),
	STRINGBUFFER_CHARAT("java.lang.StringBuffer.charAt(I)C"),
	STRINGBUFFER_CODEPOINTAT("java.lang.StringBuffer.codePointAt(I)I"),
	STRINGBUFFER_CODEPOINTBEFORE("java.lang.StringBuffer.codePointBefore(I)I"),
	STRINGBUFFER_CODEPOINTCOUNT("java.lang.StringBuffer.codePointCount(II)I"),
	STRINGBUFFER_OFFSETBYCODEPOINTS("java.lang.StringBuffer.offsetByCodePoints(II)I"),
	STRINGBUFFER_GETCHARS("java.lang.StringBuffer.getChars(II[CI)V"),
	STRINGBUFFER_SETCHARAT("java.lang.StringBuffer.setCharAt(IC)V"),
	STRINGBUFFER_APPEND("java.lang.StringBuffer.append(Ljava/lang/Object;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND2("java.lang.StringBuffer.append(Ljava/lang/String;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND3("java.lang.StringBuffer.append(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND4("java.lang.StringBuffer.append(Ljava/lang/AbstractStringBuilder;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND5("java.lang.StringBuffer.append(Ljava/lang/CharSequence;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND6("java.lang.StringBuffer.append(Ljava/lang/CharSequence;II)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND7("java.lang.StringBuffer.append([C)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND8("java.lang.StringBuffer.append([CII)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND9("java.lang.StringBuffer.append(Z)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND10("java.lang.StringBuffer.append(C)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND11("java.lang.StringBuffer.append(I)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPENDCODEPOINT("java.lang.StringBuffer.appendCodePoint(I)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND12("java.lang.StringBuffer.append(J)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND13("java.lang.StringBuffer.append(F)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_APPEND14("java.lang.StringBuffer.append(D)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_DELETE("java.lang.StringBuffer.delete(II)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_DELETECHARAT("java.lang.StringBuffer.deleteCharAt(I)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_REPLACE("java.lang.StringBuffer.replace(IILjava/lang/String;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_SUBSTRING("java.lang.StringBuffer.substring(I)Ljava/lang/String;"),
	STRINGBUFFER_SUBSEQUENCE("java.lang.StringBuffer.subSequence(II)Ljava/lang/CharSequence;"),
	STRINGBUFFER_SUBSTRING2("java.lang.StringBuffer.substring(II)Ljava/lang/String;"),
	STRINGBUFFER_INSERT("java.lang.StringBuffer.insert(I[CII)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT2("java.lang.StringBuffer.insert(ILjava/lang/Object;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT3("java.lang.StringBuffer.insert(ILjava/lang/String;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT4("java.lang.StringBuffer.insert(I[C)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT5("java.lang.StringBuffer.insert(ILjava/lang/CharSequence;)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT6("java.lang.StringBuffer.insert(ILjava/lang/CharSequence;II)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT7("java.lang.StringBuffer.insert(IZ)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT8("java.lang.StringBuffer.insert(IC)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT9("java.lang.StringBuffer.insert(II)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT10("java.lang.StringBuffer.insert(IJ)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT11("java.lang.StringBuffer.insert(IF)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INSERT12("java.lang.StringBuffer.insert(ID)Ljava/lang/StringBuffer;"),
	STRINGBUFFER_INDEXOF("java.lang.StringBuffer.indexOf(Ljava/lang/String;)I"),
	STRINGBUFFER_INDEXOF2("java.lang.StringBuffer.indexOf(Ljava/lang/String;I)I"),
	STRINGBUFFER_LASTINDEXOF("java.lang.StringBuffer.lastIndexOf(Ljava/lang/String;)I"),
	STRINGBUFFER_LASTINDEXOF2("java.lang.StringBuffer.lastIndexOf(Ljava/lang/String;I)I"),
	STRINGBUFFER_REVERSE("java.lang.StringBuffer.reverse()Ljava/lang/StringBuffer;"),
	STRINGBUFFER_TOSTRING("java.lang.StringBuffer.toString()Ljava/lang/String;"),
	STRINGBUFFER_WRITEOBJECT("java.lang.StringBuffer.writeObject(Ljava/io/ObjectOutputStream;)V"),
	STRINGBUFFER_REVERSE2("java.lang.StringBuffer.reverse()Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT13("java.lang.StringBuffer.insert(ID)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT14("java.lang.StringBuffer.insert(IF)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT15("java.lang.StringBuffer.insert(IJ)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT16("java.lang.StringBuffer.insert(II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT17("java.lang.StringBuffer.insert(IC)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT18("java.lang.StringBuffer.insert(IZ)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT19("java.lang.StringBuffer.insert(ILjava/lang/CharSequence;II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT20("java.lang.StringBuffer.insert(ILjava/lang/CharSequence;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT21("java.lang.StringBuffer.insert(I[C)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT22("java.lang.StringBuffer.insert(ILjava/lang/String;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT23("java.lang.StringBuffer.insert(ILjava/lang/Object;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_INSERT24("java.lang.StringBuffer.insert(I[CII)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_REPLACE2("java.lang.StringBuffer.replace(IILjava/lang/String;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_DELETECHARAT2("java.lang.StringBuffer.deleteCharAt(I)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPENDCODEPOINT2("java.lang.StringBuffer.appendCodePoint(I)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_DELETE2("java.lang.StringBuffer.delete(II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND15("java.lang.StringBuffer.append(D)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND16("java.lang.StringBuffer.append(F)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND17("java.lang.StringBuffer.append(J)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND18("java.lang.StringBuffer.append(I)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND19("java.lang.StringBuffer.append(C)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND20("java.lang.StringBuffer.append(Z)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND21("java.lang.StringBuffer.append([CII)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND22("java.lang.StringBuffer.append([C)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND23("java.lang.StringBuffer.append(Ljava/lang/CharSequence;II)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND24("java.lang.StringBuffer.append(Ljava/lang/CharSequence;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND25("java.lang.StringBuffer.append(Ljava/lang/AbstractStringBuilder;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND26("java.lang.StringBuffer.append(Ljava/lang/StringBuffer;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND27("java.lang.StringBuffer.append(Ljava/lang/String;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND28("java.lang.StringBuffer.append(Ljava/lang/Object;)Ljava/lang/AbstractStringBuilder;"),
	STRINGBUFFER_APPEND29("java.lang.StringBuffer.append(C)Ljava/lang/Appendable;"),
	STRINGBUFFER_APPEND30("java.lang.StringBuffer.append(Ljava/lang/CharSequence;II)Ljava/lang/Appendable;"),
	STRINGBUFFER_APPEND31("java.lang.StringBuffer.append(Ljava/lang/CharSequence;)Ljava/lang/Appendable;"),
	STRINGBUFFER_CLINIT("java.lang.StringBuffer.<clinit>()V"),
	...
	INTEGER_PARSEINT2("java.lang.Integer.parseInt(Ljava/lang/String;)I"),
	// java.io
	...
	ARRAY_SET("Array.set(ILjava/lang/Object;)V"),
	// java.security
	MESSAGEDIGEST_UPDATE2("java.security.MessageDigest.update([BII)V"),
	/**
	 *  special, in order to get a method's return name, used only in MyPathListener.java
	 */
	RETURN_EQUAL("return_equal(XX)V");
